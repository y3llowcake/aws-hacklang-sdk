...
class CommitTransactionRequest {
  ...
  public function __construct(shape(
    ...
    $this->commit_digest = $s['commit_digest'] ?? '';
...
class ExecuteStatementResult {
  ...
  public function __construct(shape(
    ...
    $this->first_page = $s['first_page'] ?? null;
  }
}
...
class SendCommandRequest {
  ...
  public function __construct(shape(
    ...
    $this->abort_transaction = $s['abort_transaction'] ?? null;
    $this->commit_transaction = $s['commit_transaction'] ?? null;
    $this->end_session = $s['end_session'] ?? null;
    $this->execute_statement = $s['execute_statement'] ?? null;
    $this->fetch_page = $s['fetch_page'] ?? null;
    $this->session_token = $s['session_token'] ?? '';
    $this->start_session = $s['start_session'] ?? null;
    $this->start_transaction = $s['start_transaction'] ?? null;
  }
}
