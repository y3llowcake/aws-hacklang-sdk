...
class BackupDescription {
  ...
  ?'source_table_feature_details' => SourceTableFeatureDetails,
    ...
    $this->backup_details = $backup_details ?? null;
    $this->source_table_details = $source_table_details ?? null;
    $this->source_table_feature_details = $source_table_feature_details ?? null;
  }
}
...
class ContinuousBackupsDescription {
  ...
  ?'point_in_time_recovery_description' => PointInTimeRecoveryDescription,
    ...
    $this->continuous_backups_status = $continuous_backups_status ?? "";
    $this->point_in_time_recovery_description = $point_in_time_recovery_description ?? null;
  }
}
...
class ContributorInsightsSummary {
  ...
  ?'table_name' => TableName,
    ...
    $this->contributor_insights_status = $contributor_insights_status ?? "";
...
class CreateGlobalTableOutput {
  ...
  ?'global_table_description' => GlobalTableDescription,
    ...
    $this->global_table_description = $global_table_description ?? null;
  }
}
...
class CreateTableOutput {
  ...
  ?'table_description' => TableDescription,
    ...
    $this->table_description = $table_description ?? null;
  }
}
...
class DeleteBackupOutput {
  ...
  ?'backup_description' => BackupDescription,
    ...
    $this->backup_description = $backup_description ?? null;
  }
}
...
class DescribeContinuousBackupsOutput {
  ...
  ?'continuous_backups_description' => ContinuousBackupsDescription,
    ...
    $this->continuous_backups_description = $continuous_backups_description ?? null;
  }
}
...
class DescribeContributorInsightsOutput {
  ...
  ?'table_name' => TableName,
    ...
    $this->contributor_insights_rule_list = $contributor_insights_rule_list ?? [];
    $this->contributor_insights_status = $contributor_insights_status ?? "";
    $this->failure_exception = $failure_exception ?? null;
    $this->index_name = $index_name ?? "";
    $this->last_update_date_time = $last_update_date_time ?? 0;
    $this->table_name = $table_name ?? "";
  }
}
...
class DescribeTableReplicaAutoScalingOutput {
  ...
  ?'table_auto_scaling_description' => TableAutoScalingDescription,
    ...
    $this->table_auto_scaling_description = $table_auto_scaling_description ?? null;
  }
}
...
class ReplicaDescription {
  ...
  ?'replica_status_percent_progress' => ReplicaStatusPercentProgress,
    ...
    $this->region_name = $region_name ?? "";
    $this->replica_status = $replica_status ?? "";
    $this->replica_status_description = $replica_status_description ?? "";
    $this->replica_status_percent_progress = $replica_status_percent_progress ?? "";
  }
}
...
class StreamSpecification {
  ...
  ?'stream_view_type' => StreamViewType,
    ...
    $this->stream_enabled = $stream_enabled ?? false;
...
class TimeToLiveDescription {
  ...
  ?'time_to_live_status' => TimeToLiveStatus,
    ...
    $this->attribute_name = $attribute_name ?? "";
    $this->time_to_live_status = $time_to_live_status ?? "";
  }
}
...
class TransactWriteItem {
  ...
  ?'update' => Update,
    ...
    $this->condition_check = $condition_check ?? null;
    $this->delete = $delete ?? null;
    $this->put = $put ?? null;
    $this->update = $update ?? null;
  }
...
class UpdateContinuousBackupsInput {
  ...
  ?'table_name' => TableName,
    ...
    $this->point_in_time_recovery_specification = $point_in_time_recovery_specification ?? null;
    $this->table_name = $table_name ?? "";
  }
}
...
class UpdateContributorInsightsInput {
  ...
  ?'table_name' => TableName,
    ...
    $this->contributor_insights_action = $contributor_insights_action ?? "";
    $this->index_name = $index_name ?? "";
    $this->table_name = $table_name ?? "";
  }
}
...
class UpdateTimeToLiveInput {
  ...
  ?'time_to_live_specification' => TimeToLiveSpecification,
    ...
    $this->table_name = $table_name ?? "";
    $this->time_to_live_specification = $time_to_live_specification ?? null;
  }
}
...
class WriteRequest {
  ...
  ?'put_request' => PutRequest,
    ...
    $this->delete_request = $delete_request ?? null;
    $this->put_request = $put_request ?? null;
  }
}
