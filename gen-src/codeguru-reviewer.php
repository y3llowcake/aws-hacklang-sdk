...
interface CodeGuruReviewer {
  public function AssociateRepository(AssociateRepositoryRequest $in): Awaitable<\Errors\Result<AssociateRepositoryResponse>>;
  public function DescribeCodeReview(DescribeCodeReviewRequest $in): Awaitable<\Errors\Result<DescribeCodeReviewResponse>>;
  public function DescribeRecommendationFeedback(DescribeRecommendationFeedbackRequest $in): Awaitable<\Errors\Result<DescribeRecommendationFeedbackResponse>>;
  public function DescribeRepositoryAssociation(DescribeRepositoryAssociationRequest $in): Awaitable<\Errors\Result<DescribeRepositoryAssociationResponse>>;
  public function DisassociateRepository(DisassociateRepositoryRequest $in): Awaitable<\Errors\Result<DisassociateRepositoryResponse>>;
  public function ListCodeReviews(ListCodeReviewsRequest $in): Awaitable<\Errors\Result<ListCodeReviewsResponse>>;
  public function ListRecommendationFeedback(ListRecommendationFeedbackRequest $in): Awaitable<\Errors\Result<ListRecommendationFeedbackResponse>>;
  public function ListRecommendations(ListRecommendationsRequest $in): Awaitable<\Errors\Result<ListRecommendationsResponse>>;
  public function ListRepositoryAssociations(ListRepositoryAssociationsRequest $in): Awaitable<\Errors\Result<ListRepositoryAssociationsResponse>>;
  public function PutRecommendationFeedback(PutRecommendationFeedbackRequest $in): Awaitable<\Errors\Result<PutRecommendationFeedbackResponse>>;
}
...
class AssociateRepositoryResponse {
  ...
  public function __construct(shape(
    ...
    $this->repository_association = $s['repository_association'] ?? null;
  }
}
...
class CodeReview {
  ...
  public function __construct(shape(
    ...
    $this->code_review_arn = $s['code_review_arn'] ?? '';
    $this->created_time_stamp = $s['created_time_stamp'] ?? 0;
    $this->last_updated_time_stamp = $s['last_updated_time_stamp'] ?? 0;
    ...
    $this->source_code_type = $s['source_code_type'] ?? null;
    $this->state = $s['state'] ?? '';
...
class CodeReviewSummary {
  ...
  public function __construct(shape(
    ...
    $this->created_time_stamp = $s['created_time_stamp'] ?? 0;
    $this->last_updated_time_stamp = $s['last_updated_time_stamp'] ?? 0;
    $this->metrics_summary = $s['metrics_summary'] ?? null;
    $this->name = $s['name'] ?? '';
    $this->owner = $s['owner'] ?? '';
    $this->provider_type = $s['provider_type'] ?? '';
    $this->pull_request_id = $s['pull_request_id'] ?? '';
...
class DescribeCodeReviewResponse {
  ...
  public function __construct(shape(
    ...
    $this->code_review = $s['code_review'] ?? null;
  }
}
...
class DescribeRecommendationFeedbackResponse {
  ...
  public function __construct(shape(
    ...
    $this->recommendation_feedback = $s['recommendation_feedback'] ?? null;
  }
}
...
class DescribeRepositoryAssociationRequest {
  ...
  public function __construct(shape(
    ...
    $this->association_arn = $s['association_arn'] ?? '';
  }
}
...
class ListCodeReviewsRequest {
  ...
  public function __construct(shape(
    ...
    $this->provider_types = $s['provider_types'] ?? vec[];
...
class ListCodeReviewsResponse {
  ...
  public function __construct(shape(
    ...
    $this->code_review_summaries = $s['code_review_summaries'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListRecommendationFeedbackRequest {
  ...
  public function __construct(shape(
    ...
    $this->max_results = $s['max_results'] ?? 0;
    $this->next_token = $s['next_token'] ?? '';
    $this->recommendation_ids = $s['recommendation_ids'] ?? vec[];
...
class ListRecommendationFeedbackResponse {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->recommendation_feedback_summaries = $s['recommendation_feedback_summaries'] ?? vec[];
  }
}
...
class ListRepositoryAssociationsResponse {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->repository_association_summaries = $s['repository_association_summaries'] ?? vec[];
  }
}
...
class Metrics {
  ...
  public function __construct(shape(
    ...
    $this->findings_count = $s['findings_count'] ?? 0;
    $this->metered_lines_of_code_count = $s['metered_lines_of_code_count'] ?? 0;
  }
}
...
class PutRecommendationFeedbackRequest {
  ...
  public function __construct(shape(
    ...
    $this->code_review_arn = $s['code_review_arn'] ?? '';
    $this->reactions = $s['reactions'] ?? vec[];
    $this->recommendation_id = $s['recommendation_id'] ?? '';
  }
}
...
class SourceCodeType {
  ...
  public function __construct(shape(
    ...
    $this->commit_diff = $s['commit_diff'] ?? null;
  }
}
