...
interface SSM {
  ...
  public function CancelCommand(CancelCommandRequest $in): Awaitable<\Errors\Result<CancelCommandResult>>;
  public function CancelMaintenanceWindowExecution(CancelMaintenanceWindowExecutionRequest $in): Awaitable<\Errors\Result<CancelMaintenanceWindowExecutionResult>>;
  public function CreateActivation(CreateActivationRequest $in): Awaitable<\Errors\Result<CreateActivationResult>>;
  public function CreateAssociation(CreateAssociationRequest $in): Awaitable<\Errors\Result<CreateAssociationResult>>;
  public function CreateAssociationBatch(CreateAssociationBatchRequest $in): Awaitable<\Errors\Result<CreateAssociationBatchResult>>;
  public function CreateDocument(CreateDocumentRequest $in): Awaitable<\Errors\Result<CreateDocumentResult>>;
  public function CreateMaintenanceWindow(CreateMaintenanceWindowRequest $in): Awaitable<\Errors\Result<CreateMaintenanceWindowResult>>;
  public function CreateOpsItem(CreateOpsItemRequest $in): Awaitable<\Errors\Result<CreateOpsItemResponse>>;
  public function CreatePatchBaseline(CreatePatchBaselineRequest $in): Awaitable<\Errors\Result<CreatePatchBaselineResult>>;
  public function CreateResourceDataSync(CreateResourceDataSyncRequest $in): Awaitable<\Errors\Result<CreateResourceDataSyncResult>>;
  public function DeleteActivation(DeleteActivationRequest $in): Awaitable<\Errors\Result<DeleteActivationResult>>;
  public function DeleteAssociation(DeleteAssociationRequest $in): Awaitable<\Errors\Result<DeleteAssociationResult>>;
  public function DeleteDocument(DeleteDocumentRequest $in): Awaitable<\Errors\Result<DeleteDocumentResult>>;
  public function DeleteInventory(DeleteInventoryRequest $in): Awaitable<\Errors\Result<DeleteInventoryResult>>;
  public function DeleteMaintenanceWindow(DeleteMaintenanceWindowRequest $in): Awaitable<\Errors\Result<DeleteMaintenanceWindowResult>>;
  public function DeleteParameter(DeleteParameterRequest $in): Awaitable<\Errors\Result<DeleteParameterResult>>;
  public function DeleteParameters(DeleteParametersRequest $in): Awaitable<\Errors\Result<DeleteParametersResult>>;
  public function DeletePatchBaseline(DeletePatchBaselineRequest $in): Awaitable<\Errors\Result<DeletePatchBaselineResult>>;
  public function DeleteResourceDataSync(DeleteResourceDataSyncRequest $in): Awaitable<\Errors\Result<DeleteResourceDataSyncResult>>;
  public function DeregisterManagedInstance(DeregisterManagedInstanceRequest $in): Awaitable<\Errors\Result<DeregisterManagedInstanceResult>>;
  public function DeregisterPatchBaselineForPatchGroup(DeregisterPatchBaselineForPatchGroupRequest $in): Awaitable<\Errors\Result<DeregisterPatchBaselineForPatchGroupResult>>;
  public function DeregisterTargetFromMaintenanceWindow(DeregisterTargetFromMaintenanceWindowRequest $in): Awaitable<\Errors\Result<DeregisterTargetFromMaintenanceWindowResult>>;
  public function DeregisterTaskFromMaintenanceWindow(DeregisterTaskFromMaintenanceWindowRequest $in): Awaitable<\Errors\Result<DeregisterTaskFromMaintenanceWindowResult>>;
  public function DescribeActivations(DescribeActivationsRequest $in): Awaitable<\Errors\Result<DescribeActivationsResult>>;
  public function DescribeAssociation(DescribeAssociationRequest $in): Awaitable<\Errors\Result<DescribeAssociationResult>>;
  public function DescribeAssociationExecutionTargets(DescribeAssociationExecutionTargetsRequest $in): Awaitable<\Errors\Result<DescribeAssociationExecutionTargetsResult>>;
  public function DescribeAssociationExecutions(DescribeAssociationExecutionsRequest $in): Awaitable<\Errors\Result<DescribeAssociationExecutionsResult>>;
  public function DescribeAutomationExecutions(DescribeAutomationExecutionsRequest $in): Awaitable<\Errors\Result<DescribeAutomationExecutionsResult>>;
  public function DescribeAutomationStepExecutions(DescribeAutomationStepExecutionsRequest $in): Awaitable<\Errors\Result<DescribeAutomationStepExecutionsResult>>;
  public function DescribeAvailablePatches(DescribeAvailablePatchesRequest $in): Awaitable<\Errors\Result<DescribeAvailablePatchesResult>>;
  public function DescribeDocument(DescribeDocumentRequest $in): Awaitable<\Errors\Result<DescribeDocumentResult>>;
  public function DescribeDocumentPermission(DescribeDocumentPermissionRequest $in): Awaitable<\Errors\Result<DescribeDocumentPermissionResponse>>;
  public function DescribeEffectiveInstanceAssociations(DescribeEffectiveInstanceAssociationsRequest $in): Awaitable<\Errors\Result<DescribeEffectiveInstanceAssociationsResult>>;
  public function DescribeEffectivePatchesForPatchBaseline(DescribeEffectivePatchesForPatchBaselineRequest $in): Awaitable<\Errors\Result<DescribeEffectivePatchesForPatchBaselineResult>>;
  public function DescribeInstanceAssociationsStatus(DescribeInstanceAssociationsStatusRequest $in): Awaitable<\Errors\Result<DescribeInstanceAssociationsStatusResult>>;
  public function DescribeInstanceInformation(DescribeInstanceInformationRequest $in): Awaitable<\Errors\Result<DescribeInstanceInformationResult>>;
  public function DescribeInstancePatchStates(DescribeInstancePatchStatesRequest $in): Awaitable<\Errors\Result<DescribeInstancePatchStatesResult>>;
  public function DescribeInstancePatchStatesForPatchGroup(DescribeInstancePatchStatesForPatchGroupRequest $in): Awaitable<\Errors\Result<DescribeInstancePatchStatesForPatchGroupResult>>;
  public function DescribeInstancePatches(DescribeInstancePatchesRequest $in): Awaitable<\Errors\Result<DescribeInstancePatchesResult>>;
  public function DescribeInventoryDeletions(DescribeInventoryDeletionsRequest $in): Awaitable<\Errors\Result<DescribeInventoryDeletionsResult>>;
  public function DescribeMaintenanceWindowExecutionTaskInvocations(DescribeMaintenanceWindowExecutionTaskInvocationsRequest $in): Awaitable<\Errors\Result<DescribeMaintenanceWindowExecutionTaskInvocationsResult>>;
  public function DescribeMaintenanceWindowExecutionTasks(DescribeMaintenanceWindowExecutionTasksRequest $in): Awaitable<\Errors\Result<DescribeMaintenanceWindowExecutionTasksResult>>;
  public function DescribeMaintenanceWindowExecutions(DescribeMaintenanceWindowExecutionsRequest $in): Awaitable<\Errors\Result<DescribeMaintenanceWindowExecutionsResult>>;
  public function DescribeMaintenanceWindowSchedule(DescribeMaintenanceWindowScheduleRequest $in): Awaitable<\Errors\Result<DescribeMaintenanceWindowScheduleResult>>;
  public function DescribeMaintenanceWindowTargets(DescribeMaintenanceWindowTargetsRequest $in): Awaitable<\Errors\Result<DescribeMaintenanceWindowTargetsResult>>;
  public function DescribeMaintenanceWindowTasks(DescribeMaintenanceWindowTasksRequest $in): Awaitable<\Errors\Result<DescribeMaintenanceWindowTasksResult>>;
  public function DescribeMaintenanceWindows(DescribeMaintenanceWindowsRequest $in): Awaitable<\Errors\Result<DescribeMaintenanceWindowsResult>>;
  public function DescribeMaintenanceWindowsForTarget(DescribeMaintenanceWindowsForTargetRequest $in): Awaitable<\Errors\Result<DescribeMaintenanceWindowsForTargetResult>>;
  public function DescribeOpsItems(DescribeOpsItemsRequest $in): Awaitable<\Errors\Result<DescribeOpsItemsResponse>>;
  public function DescribeParameters(DescribeParametersRequest $in): Awaitable<\Errors\Result<DescribeParametersResult>>;
  public function DescribePatchBaselines(DescribePatchBaselinesRequest $in): Awaitable<\Errors\Result<DescribePatchBaselinesResult>>;
  public function DescribePatchGroupState(DescribePatchGroupStateRequest $in): Awaitable<\Errors\Result<DescribePatchGroupStateResult>>;
  public function DescribePatchGroups(DescribePatchGroupsRequest $in): Awaitable<\Errors\Result<DescribePatchGroupsResult>>;
  public function DescribePatchProperties(DescribePatchPropertiesRequest $in): Awaitable<\Errors\Result<DescribePatchPropertiesResult>>;
  public function DescribeSessions(DescribeSessionsRequest $in): Awaitable<\Errors\Result<DescribeSessionsResponse>>;
  public function GetAutomationExecution(GetAutomationExecutionRequest $in): Awaitable<\Errors\Result<GetAutomationExecutionResult>>;
  public function GetCalendarState(GetCalendarStateRequest $in): Awaitable<\Errors\Result<GetCalendarStateResponse>>;
  public function GetCommandInvocation(GetCommandInvocationRequest $in): Awaitable<\Errors\Result<GetCommandInvocationResult>>;
  public function GetConnectionStatus(GetConnectionStatusRequest $in): Awaitable<\Errors\Result<GetConnectionStatusResponse>>;
  public function GetDefaultPatchBaseline(GetDefaultPatchBaselineRequest $in): Awaitable<\Errors\Result<GetDefaultPatchBaselineResult>>;
  public function GetDeployablePatchSnapshotForInstance(GetDeployablePatchSnapshotForInstanceRequest $in): Awaitable<\Errors\Result<GetDeployablePatchSnapshotForInstanceResult>>;
  public function GetDocument(GetDocumentRequest $in): Awaitable<\Errors\Result<GetDocumentResult>>;
  public function GetInventory(GetInventoryRequest $in): Awaitable<\Errors\Result<GetInventoryResult>>;
  public function GetInventorySchema(GetInventorySchemaRequest $in): Awaitable<\Errors\Result<GetInventorySchemaResult>>;
  public function GetMaintenanceWindow(GetMaintenanceWindowRequest $in): Awaitable<\Errors\Result<GetMaintenanceWindowResult>>;
  public function GetMaintenanceWindowExecution(GetMaintenanceWindowExecutionRequest $in): Awaitable<\Errors\Result<GetMaintenanceWindowExecutionResult>>;
  public function GetMaintenanceWindowExecutionTask(GetMaintenanceWindowExecutionTaskRequest $in): Awaitable<\Errors\Result<GetMaintenanceWindowExecutionTaskResult>>;
  public function GetMaintenanceWindowExecutionTaskInvocation(GetMaintenanceWindowExecutionTaskInvocationRequest $in): Awaitable<\Errors\Result<GetMaintenanceWindowExecutionTaskInvocationResult>>;
  public function GetMaintenanceWindowTask(GetMaintenanceWindowTaskRequest $in): Awaitable<\Errors\Result<GetMaintenanceWindowTaskResult>>;
  public function GetOpsItem(GetOpsItemRequest $in): Awaitable<\Errors\Result<GetOpsItemResponse>>;
  public function GetOpsSummary(GetOpsSummaryRequest $in): Awaitable<\Errors\Result<GetOpsSummaryResult>>;
  public function GetParameter(GetParameterRequest $in): Awaitable<\Errors\Result<GetParameterResult>>;
  public function GetParameterHistory(GetParameterHistoryRequest $in): Awaitable<\Errors\Result<GetParameterHistoryResult>>;
  public function GetParameters(GetParametersRequest $in): Awaitable<\Errors\Result<GetParametersResult>>;
  public function GetParametersByPath(GetParametersByPathRequest $in): Awaitable<\Errors\Result<GetParametersByPathResult>>;
  public function GetPatchBaseline(GetPatchBaselineRequest $in): Awaitable<\Errors\Result<GetPatchBaselineResult>>;
  public function GetPatchBaselineForPatchGroup(GetPatchBaselineForPatchGroupRequest $in): Awaitable<\Errors\Result<GetPatchBaselineForPatchGroupResult>>;
  public function GetServiceSetting(GetServiceSettingRequest $in): Awaitable<\Errors\Result<GetServiceSettingResult>>;
  public function LabelParameterVersion(LabelParameterVersionRequest $in): Awaitable<\Errors\Result<LabelParameterVersionResult>>;
  public function ListAssociationVersions(ListAssociationVersionsRequest $in): Awaitable<\Errors\Result<ListAssociationVersionsResult>>;
  public function ListAssociations(ListAssociationsRequest $in): Awaitable<\Errors\Result<ListAssociationsResult>>;
  public function ListCommandInvocations(ListCommandInvocationsRequest $in): Awaitable<\Errors\Result<ListCommandInvocationsResult>>;
  public function ListCommands(ListCommandsRequest $in): Awaitable<\Errors\Result<ListCommandsResult>>;
  public function ListComplianceItems(ListComplianceItemsRequest $in): Awaitable<\Errors\Result<ListComplianceItemsResult>>;
  public function ListComplianceSummaries(ListComplianceSummariesRequest $in): Awaitable<\Errors\Result<ListComplianceSummariesResult>>;
  public function ListDocumentVersions(ListDocumentVersionsRequest $in): Awaitable<\Errors\Result<ListDocumentVersionsResult>>;
  public function ListDocuments(ListDocumentsRequest $in): Awaitable<\Errors\Result<ListDocumentsResult>>;
  public function ListInventoryEntries(ListInventoryEntriesRequest $in): Awaitable<\Errors\Result<ListInventoryEntriesResult>>;
  public function ListResourceComplianceSummaries(ListResourceComplianceSummariesRequest $in): Awaitable<\Errors\Result<ListResourceComplianceSummariesResult>>;
  public function ListResourceDataSync(ListResourceDataSyncRequest $in): Awaitable<\Errors\Result<ListResourceDataSyncResult>>;
  public function ListTagsForResource(ListTagsForResourceRequest $in): Awaitable<\Errors\Result<ListTagsForResourceResult>>;
  public function ModifyDocumentPermission(ModifyDocumentPermissionRequest $in): Awaitable<\Errors\Result<ModifyDocumentPermissionResponse>>;
  public function PutComplianceItems(PutComplianceItemsRequest $in): Awaitable<\Errors\Result<PutComplianceItemsResult>>;
  public function PutInventory(PutInventoryRequest $in): Awaitable<\Errors\Result<PutInventoryResult>>;
  public function PutParameter(PutParameterRequest $in): Awaitable<\Errors\Result<PutParameterResult>>;
  public function RegisterDefaultPatchBaseline(RegisterDefaultPatchBaselineRequest $in): Awaitable<\Errors\Result<RegisterDefaultPatchBaselineResult>>;
  public function RegisterPatchBaselineForPatchGroup(RegisterPatchBaselineForPatchGroupRequest $in): Awaitable<\Errors\Result<RegisterPatchBaselineForPatchGroupResult>>;
  public function RegisterTargetWithMaintenanceWindow(RegisterTargetWithMaintenanceWindowRequest $in): Awaitable<\Errors\Result<RegisterTargetWithMaintenanceWindowResult>>;
  public function RegisterTaskWithMaintenanceWindow(RegisterTaskWithMaintenanceWindowRequest $in): Awaitable<\Errors\Result<RegisterTaskWithMaintenanceWindowResult>>;
  ...
  public function ResetServiceSetting(ResetServiceSettingRequest $in): Awaitable<\Errors\Result<ResetServiceSettingResult>>;
  public function ResumeSession(ResumeSessionRequest $in): Awaitable<\Errors\Result<ResumeSessionResponse>>;
  public function SendAutomationSignal(SendAutomationSignalRequest $in): Awaitable<\Errors\Result<SendAutomationSignalResult>>;
  public function SendCommand(SendCommandRequest $in): Awaitable<\Errors\Result<SendCommandResult>>;
  public function StartAssociationsOnce(StartAssociationsOnceRequest $in): Awaitable<\Errors\Result<StartAssociationsOnceResult>>;
  public function StartAutomationExecution(StartAutomationExecutionRequest $in): Awaitable<\Errors\Result<StartAutomationExecutionResult>>;
  public function StartSession(StartSessionRequest $in): Awaitable<\Errors\Result<StartSessionResponse>>;
  public function StopAutomationExecution(StopAutomationExecutionRequest $in): Awaitable<\Errors\Result<StopAutomationExecutionResult>>;
  public function TerminateSession(TerminateSessionRequest $in): Awaitable<\Errors\Result<TerminateSessionResponse>>;
  public function UpdateAssociation(UpdateAssociationRequest $in): Awaitable<\Errors\Result<UpdateAssociationResult>>;
  public function UpdateAssociationStatus(UpdateAssociationStatusRequest $in): Awaitable<\Errors\Result<UpdateAssociationStatusResult>>;
  public function UpdateDocument(UpdateDocumentRequest $in): Awaitable<\Errors\Result<UpdateDocumentResult>>;
  public function UpdateDocumentDefaultVersion(UpdateDocumentDefaultVersionRequest $in): Awaitable<\Errors\Result<UpdateDocumentDefaultVersionResult>>;
  public function UpdateMaintenanceWindow(UpdateMaintenanceWindowRequest $in): Awaitable<\Errors\Result<UpdateMaintenanceWindowResult>>;
  public function UpdateMaintenanceWindowTarget(UpdateMaintenanceWindowTargetRequest $in): Awaitable<\Errors\Result<UpdateMaintenanceWindowTargetResult>>;
  public function UpdateMaintenanceWindowTask(UpdateMaintenanceWindowTaskRequest $in): Awaitable<\Errors\Result<UpdateMaintenanceWindowTaskResult>>;
  public function UpdateManagedInstanceRole(UpdateManagedInstanceRoleRequest $in): Awaitable<\Errors\Result<UpdateManagedInstanceRoleResult>>;
  public function UpdateOpsItem(UpdateOpsItemRequest $in): Awaitable<\Errors\Result<UpdateOpsItemResponse>>;
  public function UpdatePatchBaseline(UpdatePatchBaselineRequest $in): Awaitable<\Errors\Result<UpdatePatchBaselineResult>>;
  public function UpdateResourceDataSync(UpdateResourceDataSyncRequest $in): Awaitable<\Errors\Result<UpdateResourceDataSyncResult>>;
  public function UpdateServiceSetting(UpdateServiceSettingRequest $in): Awaitable<\Errors\Result<UpdateServiceSettingResult>>;
}
...
class AccountSharingInfo {
  ...
  public function __construct(shape(
    ...
    $this->shared_document_version = $s['shared_document_version'] ?? '';
  }
}
...
class Activation {
  ...
  public function __construct(shape(
    ...
    $this->activation_id = $s['activation_id'] ?? '';
    $this->created_date = $s['created_date'] ?? 0;
    $this->default_instance_name = $s['default_instance_name'] ?? '';
    $this->description = $s['description'] ?? '';
    $this->expiration_date = $s['expiration_date'] ?? 0;
    $this->expired = $s['expired'] ?? false;
    $this->iam_role = $s['iam_role'] ?? '';
    $this->registration_limit = $s['registration_limit'] ?? 0;
    $this->registrations_count = $s['registrations_count'] ?? 0;
...
class Association {
  ...
  public function __construct(shape(
    ...
    $this->association_name = $s['association_name'] ?? '';
    $this->association_version = $s['association_version'] ?? '';
    $this->document_version = $s['document_version'] ?? '';
    $this->instance_id = $s['instance_id'] ?? '';
    $this->last_execution_date = $s['last_execution_date'] ?? 0;
    $this->name = $s['name'] ?? '';
    $this->overview = $s['overview'] ?? null;
...
class AssociationDescription {
  ...
  public function __construct(shape(
    ...
    $this->association_name = $s['association_name'] ?? '';
    $this->association_version = $s['association_version'] ?? '';
    $this->automation_target_parameter_name = $s['automation_target_parameter_name'] ?? '';
    $this->compliance_severity = $s['compliance_severity'] ?? '';
    $this->date = $s['date'] ?? 0;
    $this->document_version = $s['document_version'] ?? '';
    $this->instance_id = $s['instance_id'] ?? '';
    $this->last_execution_date = $s['last_execution_date'] ?? 0;
    $this->last_successful_execution_date = $s['last_successful_execution_date'] ?? 0;
    $this->last_update_association_date = $s['last_update_association_date'] ?? 0;
    $this->max_concurrency = $s['max_concurrency'] ?? '';
    $this->max_errors = $s['max_errors'] ?? '';
    $this->name = $s['name'] ?? '';
...
class AssociationExecution {
  ...
  public function __construct(shape(
    ...
    $this->detailed_status = $s['detailed_status'] ?? '';
    $this->execution_id = $s['execution_id'] ?? '';
    $this->last_execution_date = $s['last_execution_date'] ?? 0;
    $this->resource_count_by_status = $s['resource_count_by_status'] ?? '';
...
class AssociationExecutionTarget {
  ...
  public function __construct(shape(
    ...
    $this->execution_id = $s['execution_id'] ?? '';
    $this->last_execution_date = $s['last_execution_date'] ?? 0;
    $this->output_source = $s['output_source'] ?? null;
    $this->resource_id = $s['resource_id'] ?? '';
    $this->resource_type = $s['resource_type'] ?? '';
    $this->status = $s['status'] ?? '';
  }
...
class AssociationOverview {
  ...
  public function __construct(shape(
    ...
    $this->association_status_aggregated_count = $s['association_status_aggregated_count'] ?? dict[];
    $this->detailed_status = $s['detailed_status'] ?? '';
    $this->status = $s['status'] ?? '';
  }
}
...
class AutomationExecution {
  ...
  public bool $step_executions_truncated;
  ...
  public function __construct(shape(
    ...
    $this->automation_execution_id = $s['automation_execution_id'] ?? '';
    $this->automation_execution_status = $s['automation_execution_status'] ?? '';
    $this->current_action = $s['current_action'] ?? '';
    $this->current_step_name = $s['current_step_name'] ?? '';
    $this->document_name = $s['document_name'] ?? '';
    $this->document_version = $s['document_version'] ?? '';
    $this->executed_by = $s['executed_by'] ?? '';
    $this->execution_end_time = $s['execution_end_time'] ?? 0;
    $this->execution_start_time = $s['execution_start_time'] ?? 0;
    $this->failure_message = $s['failure_message'] ?? '';
    $this->max_concurrency = $s['max_concurrency'] ?? '';
    $this->max_errors = $s['max_errors'] ?? '';
    $this->mode = $s['mode'] ?? '';
    $this->outputs = $s['outputs'] ?? dict[];
    $this->parameters = $s['parameters'] ?? dict[];
    $this->parent_automation_execution_id = $s['parent_automation_execution_id'] ?? '';
    $this->progress_counters = $s['progress_counters'] ?? null;
    $this->resolved_targets = $s['resolved_targets'] ?? null;
    $this->step_executions = $s['step_executions'] ?? vec[];
    $this->step_executions_truncated = $s['step_executions_truncated'] ?? false;
    $this->target = $s['target'] ?? '';
    $this->target_locations = $s['target_locations'] ?? vec[];
    $this->target_maps = $s['target_maps'] ?? vec[];
    $this->target_parameter_name = $s['target_parameter_name'] ?? '';
    $this->targets = $s['targets'] ?? vec[];
  }
}
...
class AutomationExecutionMetadata {
  ...
  public function __construct(shape(
    ...
    $this->automation_execution_id = $s['automation_execution_id'] ?? '';
    $this->automation_execution_status = $s['automation_execution_status'] ?? '';
    $this->automation_type = $s['automation_type'] ?? '';
    $this->current_action = $s['current_action'] ?? '';
    $this->current_step_name = $s['current_step_name'] ?? '';
    $this->document_name = $s['document_name'] ?? '';
    $this->document_version = $s['document_version'] ?? '';
...
class CancelMaintenanceWindowExecutionRequest {
  ...
  public function __construct(shape(
    ...
    $this->window_execution_id = $s['window_execution_id'] ?? '';
  }
}
...
class CloudWatchOutputConfig {
  ...
  public function __construct(shape(
    ...
    $this->cloud_watch_log_group_name = $s['cloud_watch_log_group_name'] ?? '';
    $this->cloud_watch_output_enabled = $s['cloud_watch_output_enabled'] ?? false;
  }
}
...
class Command {
  ...
  public function __construct(shape(
    ...
    $this->cloud_watch_output_config = $s['cloud_watch_output_config'] ?? null;
    $this->command_id = $s['command_id'] ?? '';
    $this->comment = $s['comment'] ?? '';
    $this->completed_count = $s['completed_count'] ?? 0;
    $this->delivery_timed_out_count = $s['delivery_timed_out_count'] ?? 0;
    $this->document_name = $s['document_name'] ?? '';
    $this->document_version = $s['document_version'] ?? '';
    $this->error_count = $s['error_count'] ?? 0;
    $this->expires_after = $s['expires_after'] ?? 0;
    $this->instance_ids = $s['instance_ids'] ?? vec[];
    $this->max_concurrency = $s['max_concurrency'] ?? '';
    $this->max_errors = $s['max_errors'] ?? '';
    $this->notification_config = $s['notification_config'] ?? null;
    $this->output_s_3_bucket_name = $s['output_s_3_bucket_name'] ?? '';
    $this->output_s_3_key_prefix = $s['output_s_3_key_prefix'] ?? '';
    $this->output_s_3_region = $s['output_s_3_region'] ?? '';
    $this->parameters = $s['parameters'] ?? dict[];
    $this->requested_date_time = $s['requested_date_time'] ?? 0;
    $this->service_role = $s['service_role'] ?? '';
    $this->status = $s['status'] ?? '';
    $this->status_details = $s['status_details'] ?? '';
    $this->target_count = $s['target_count'] ?? 0;
    $this->targets = $s['targets'] ?? vec[];
  }
}
...
class CommandInvocation {
  ...
  public function __construct(shape(
    ...
    $this->cloud_watch_output_config = $s['cloud_watch_output_config'] ?? null;
    $this->command_id = $s['command_id'] ?? '';
    $this->command_plugins = $s['command_plugins'] ?? vec[];
    $this->comment = $s['comment'] ?? '';
    $this->document_name = $s['document_name'] ?? '';
    $this->document_version = $s['document_version'] ?? '';
    $this->instance_id = $s['instance_id'] ?? '';
    ...
    $this->requested_date_time = $s['requested_date_time'] ?? 0;
    $this->service_role = $s['service_role'] ?? '';
    $this->standard_error_url = $s['standard_error_url'] ?? '';
    $this->standard_output_url = $s['standard_output_url'] ?? '';
    $this->status = $s['status'] ?? '';
    $this->status_details = $s['status_details'] ?? '';
    $this->trace_output = $s['trace_output'] ?? '';
  }
}
...
class CommandPlugin {
  ...
  public function __construct(shape(
    ...
    $this->output_s_3_key_prefix = $s['output_s_3_key_prefix'] ?? '';
    $this->output_s_3_region = $s['output_s_3_region'] ?? '';
    $this->response_code = $s['response_code'] ?? 0;
    $this->response_finish_date_time = $s['response_finish_date_time'] ?? 0;
    $this->response_start_date_time = $s['response_start_date_time'] ?? 0;
    $this->standard_error_url = $s['standard_error_url'] ?? '';
    $this->standard_output_url = $s['standard_output_url'] ?? '';
    $this->status = $s['status'] ?? '';
    $this->status_details = $s['status_details'] ?? '';
...
class ComplianceExecutionSummary {
  ...
  public function __construct(shape(
    ...
    $this->execution_type = $s['execution_type'] ?? '';
  }
}
...
class ComplianceItem {
  ...
  public function __construct(shape(
    ...
    $this->execution_summary = $s['execution_summary'] ?? null;
    $this->id = $s['id'] ?? '';
    $this->resource_id = $s['resource_id'] ?? '';
    $this->resource_type = $s['resource_type'] ?? '';
...
class ComplianceSummaryItem {
  ...
  public function __construct(shape(
    ...
    $this->compliance_type = $s['compliance_type'] ?? '';
    $this->compliant_summary = $s['compliant_summary'] ?? null;
    $this->non_compliant_summary = $s['non_compliant_summary'] ?? null;
  }
}
...
class CompliantSummary {
  ...
  public function __construct(shape(
    ...
    $this->compliant_count = $s['compliant_count'] ?? 0;
    $this->severity_summary = $s['severity_summary'] ?? null;
  }
}
...
class CreateActivationResult {
  ...
  public function __construct(shape(
    ...
    $this->activation_code = $s['activation_code'] ?? '';
    $this->activation_id = $s['activation_id'] ?? '';
  }
}
...
class CreateAssociationResult {
  ...
  public function __construct(shape(
    ...
    $this->association_description = $s['association_description'] ?? null;
  }
}
...
class CreateDocumentRequest {
  ...
  public function __construct(shape(
    ...
    $this->document_format = $s['document_format'] ?? '';
...
class CreateDocumentResult {
  ...
  public function __construct(shape(
    ...
    $this->document_description = $s['document_description'] ?? null;
  }
}
...
class CreateMaintenanceWindowRequest {
  ...
  public function __construct(shape(
    ...
    $this->allow_unassociated_targets = $s['allow_unassociated_targets'] ?? false;
    $this->client_token = $s['client_token'] ?? '';
    $this->cutoff = $s['cutoff'] ?? 0;
    $this->description = $s['description'] ?? '';
    $this->duration = $s['duration'] ?? 0;
    $this->end_date = $s['end_date'] ?? '';
    $this->name = $s['name'] ?? '';
    $this->schedule = $s['schedule'] ?? '';
    $this->schedule_timezone = $s['schedule_timezone'] ?? '';
...
class CreateOpsItemRequest {
  ...
  public function __construct(shape(
    ...
    $this->operational_data = $s['operational_data'] ?? dict[];
    $this->priority = $s['priority'] ?? 0;
    $this->related_ops_items = $s['related_ops_items'] ?? vec[];
    $this->severity = $s['severity'] ?? '';
...
class CreateOpsItemResponse {
  ...
  public function __construct(shape(
    ...
    $this->ops_item_id = $s['ops_item_id'] ?? '';
  }
}
...
class CreatePatchBaselineRequest {
  ...
  public bool $approved_patches_enable_non_security;
  public ?ClientToken $client_token;
  ...
  public function __construct(shape(
    ...
    $this->approval_rules = $s['approval_rules'] ?? null;
    $this->approved_patches = $s['approved_patches'] ?? vec[];
    $this->approved_patches_compliance_level = $s['approved_patches_compliance_level'] ?? '';
    $this->approved_patches_enable_non_security = $s['approved_patches_enable_non_security'] ?? false;
    $this->client_token = $s['client_token'] ?? '';
    $this->description = $s['description'] ?? '';
    $this->global_filters = $s['global_filters'] ?? null;
    $this->name = $s['name'] ?? '';
    $this->operating_system = $s['operating_system'] ?? '';
    $this->rejected_patches = $s['rejected_patches'] ?? vec[];
    $this->rejected_patches_action = $s['rejected_patches_action'] ?? '';
...
class CreatePatchBaselineResult {
  ...
  public function __construct(shape(
    ...
    $this->baseline_id = $s['baseline_id'] ?? '';
  }
}
...
class CreateResourceDataSyncRequest {
  ...
  public function __construct(shape(
    ...
    $this->sync_name = $s['sync_name'] ?? '';
    $this->sync_source = $s['sync_source'] ?? null;
    $this->sync_type = $s['sync_type'] ?? '';
  }
}
...
class DeleteInventoryRequest {
  ...
  public function __construct(shape(
    ...
    $this->schema_delete_option = $s['schema_delete_option'] ?? '';
...
class DeleteInventoryResult {
  ...
  public function __construct(shape(
    ...
    $this->deletion_id = $s['deletion_id'] ?? '';
    $this->deletion_summary = $s['deletion_summary'] ?? null;
    $this->type_name = $s['type_name'] ?? '';
  }
}
...
class DeleteParametersResult {
  ...
  public function __construct(shape(
    ...
    $this->deleted_parameters = $s['deleted_parameters'] ?? vec[];
    $this->invalid_parameters = $s['invalid_parameters'] ?? vec[];
  }
}
...
class DeregisterPatchBaselineForPatchGroupRequest {
  ...
  public function __construct(shape(
    ...
    $this->baseline_id = $s['baseline_id'] ?? '';
    $this->patch_group = $s['patch_group'] ?? '';
  }
}
...
class DeregisterTargetFromMaintenanceWindowRequest {
  ...
  public function __construct(shape(
    ...
    $this->safe = $s['safe'] ?? false;
    $this->window_id = $s['window_id'] ?? '';
    $this->window_target_id = $s['window_target_id'] ?? '';
  }
}
...
class DeregisterTaskFromMaintenanceWindowRequest {
  ...
  public function __construct(shape(
    ...
    $this->window_id = $s['window_id'] ?? '';
    $this->window_task_id = $s['window_task_id'] ?? '';
  }
}
...
class DescribeActivationsFilter {
  ...
  public function __construct(shape(
    ...
    $this->filter_key = $s['filter_key'] ?? '';
    $this->filter_values = $s['filter_values'] ?? vec[];
  }
}
...
class DescribeActivationsResult {
  ...
  public function __construct(shape(
    ...
    $this->activation_list = $s['activation_list'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class DescribeAssociationExecutionTargetsResult {
  ...
  public function __construct(shape(
    ...
    $this->association_execution_targets = $s['association_execution_targets'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class DescribeAssociationExecutionsResult {
  ...
  public function __construct(shape(
    ...
    $this->association_executions = $s['association_executions'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class DescribeAutomationExecutionsResult {
  ...
  public function __construct(shape(
    ...
    $this->automation_execution_metadata_list = $s['automation_execution_metadata_list'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class DescribeDocumentPermissionRequest {
  ...
  public function __construct(shape(
    ...
    $this->name = $s['name'] ?? '';
    $this->permission_type = $s['permission_type'] ?? '';
  }
}
...
class DescribeDocumentPermissionResponse {
  ...
  public function __construct(shape(
    ...
    $this->account_sharing_info_list = $s['account_sharing_info_list'] ?? vec[];
  }
}
...
class DescribeEffectivePatchesForPatchBaselineResult {
  ...
  public function __construct(shape(
    ...
    $this->effective_patches = $s['effective_patches'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class DescribeInstanceAssociationsStatusResult {
  ...
  public function __construct(shape(
    ...
    $this->instance_association_status_infos = $s['instance_association_status_infos'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class DescribeInstanceInformationRequest {
  ...
  public function __construct(shape(
    ...
    $this->filters = $s['filters'] ?? vec[];
    $this->instance_information_filter_list = $s['instance_information_filter_list'] ?? vec[];
    $this->max_results = $s['max_results'] ?? 0;
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class DescribeInstanceInformationResult {
  ...
  public function __construct(shape(
    ...
    $this->instance_information_list = $s['instance_information_list'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class DescribeInstancePatchStatesForPatchGroupResult {
  ...
  public function __construct(shape(
    ...
    $this->instance_patch_states = $s['instance_patch_states'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class DescribeInventoryDeletionsResult {
  ...
  public function __construct(shape(
    ...
    $this->inventory_deletions = $s['inventory_deletions'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class DescribeMaintenanceWindowExecutionTaskInvocationsResult {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->window_execution_task_invocation_identities = $s['window_execution_task_invocation_identities'] ?? vec[];
  }
}
...
class DescribeMaintenanceWindowExecutionTasksResult {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->window_execution_task_identities = $s['window_execution_task_identities'] ?? vec[];
  }
}
...
class DescribeMaintenanceWindowExecutionsResult {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->window_executions = $s['window_executions'] ?? vec[];
  }
}
...
class DescribeMaintenanceWindowScheduleResult {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->scheduled_window_executions = $s['scheduled_window_executions'] ?? vec[];
  }
}
...
class DescribeMaintenanceWindowsForTargetResult {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->window_identities = $s['window_identities'] ?? vec[];
  }
}
...
class DescribeOpsItemsRequest {
  ...
  public function __construct(shape(
    ...
    $this->max_results = $s['max_results'] ?? 0;
    $this->next_token = $s['next_token'] ?? '';
    $this->ops_item_filters = $s['ops_item_filters'] ?? vec[];
  }
}
...
class DescribeOpsItemsResponse {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->ops_item_summaries = $s['ops_item_summaries'] ?? vec[];
  }
}
...
class DescribeParametersRequest {
  ...
  public function __construct(shape(
    ...
    $this->max_results = $s['max_results'] ?? 0;
    $this->next_token = $s['next_token'] ?? '';
    $this->parameter_filters = $s['parameter_filters'] ?? vec[];
  }
}
...
class DescribePatchBaselinesResult {
  ...
  public function __construct(shape(
    ...
    $this->baseline_identities = $s['baseline_identities'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class DescribePatchGroupStateResult {
  ...
  public function __construct(shape(
    ...
    $this->instances = $s['instances'] ?? 0;
    $this->instances_with_failed_patches = $s['instances_with_failed_patches'] ?? 0;
    $this->instances_with_installed_other_patches = $s['instances_with_installed_other_patches'] ?? 0;
    $this->instances_with_installed_patches = $s['instances_with_installed_patches'] ?? 0;
    $this->instances_with_installed_pending_reboot_patches = $s['instances_with_installed_pending_reboot_patches'] ?? 0;
    $this->instances_with_installed_rejected_patches = $s['instances_with_installed_rejected_patches'] ?? 0;
    $this->instances_with_missing_patches = $s['instances_with_missing_patches'] ?? 0;
    $this->instances_with_not_applicable_patches = $s['instances_with_not_applicable_patches'] ?? 0;
    $this->instances_with_unreported_not_applicable_patches = $s['instances_with_unreported_not_applicable_patches'] ?? 0;
  }
}
...
class DocumentDefaultVersionDescription {
  ...
  public function __construct(shape(
    ...
    $this->default_version_name = $s['default_version_name'] ?? '';
    $this->name = $s['name'] ?? '';
  }
}
...
class DocumentDescription {
  ...
  public function __construct(shape(
    ...
    $this->attachments_information = $s['attachments_information'] ?? vec[];
    $this->created_date = $s['created_date'] ?? 0;
    $this->default_version = $s['default_version'] ?? '';
    $this->description = $s['description'] ?? '';
    $this->document_format = $s['document_format'] ?? '';
    ...
    $this->owner = $s['owner'] ?? '';
    $this->parameters = $s['parameters'] ?? vec[];
    $this->platform_types = $s['platform_types'] ?? vec[];
    $this->requires = $s['requires'] ?? vec[];
    $this->schema_version = $s['schema_version'] ?? '';
    $this->sha_1 = $s['sha_1'] ?? '';
    $this->status = $s['status'] ?? '';
    $this->status_information = $s['status_information'] ?? '';
    $this->tags = $s['tags'] ?? vec[];
    $this->target_type = $s['target_type'] ?? '';
    $this->version_name = $s['version_name'] ?? '';
  }
...
class DocumentVersionInfo {
  ...
  public ?DocumentFormat $document_format;
  public ?DocumentVersion $document_version;
  public bool $is_default_version;
  public ?DocumentName $name;
  public ?DocumentStatus $status;
  public ?DocumentStatusInformation $status_information;
  public ?DocumentVersionName $version_name;
...
class EffectivePatch {
  ...
  public function __construct(shape(
    ...
    $this->patch = $s['patch'] ?? null;
    $this->patch_status = $s['patch_status'] ?? null;
  }
}
...
class FailureDetails {
  ...
  public function __construct(shape(
    ...
    $this->details = $s['details'] ?? dict[];
    $this->failure_stage = $s['failure_stage'] ?? '';
...
class GetAutomationExecutionResult {
  ...
  public function __construct(shape(
    ...
    $this->automation_execution = $s['automation_execution'] ?? null;
  }
}
...
class GetCalendarStateRequest {
  ...
  public function __construct(shape(
    ...
    $this->at_time = $s['at_time'] ?? '';
    $this->calendar_names = $s['calendar_names'] ?? vec[];
  }
}
...
class GetCalendarStateResponse {
  ...
  public function __construct(shape(
    ...
    $this->at_time = $s['at_time'] ?? '';
    $this->next_transition_time = $s['next_transition_time'] ?? '';
    $this->state = $s['state'] ?? '';
  }
}
...
class GetCommandInvocationRequest {
  ...
  public function __construct(shape(
    ...
    $this->command_id = $s['command_id'] ?? '';
    $this->instance_id = $s['instance_id'] ?? '';
    $this->plugin_name = $s['plugin_name'] ?? '';
  }
}
...
class GetCommandInvocationResult {
  ...
  public function __construct(shape(
    ...
    $this->document_name = $s['document_name'] ?? '';
    $this->document_version = $s['document_version'] ?? '';
    $this->execution_elapsed_time = $s['execution_elapsed_time'] ?? '';
    $this->execution_end_date_time = $s['execution_end_date_time'] ?? '';
    $this->execution_start_date_time = $s['execution_start_date_time'] ?? '';
    $this->instance_id = $s['instance_id'] ?? '';
    $this->plugin_name = $s['plugin_name'] ?? '';
    $this->response_code = $s['response_code'] ?? 0;
    $this->standard_error_content = $s['standard_error_content'] ?? '';
    $this->standard_error_url = $s['standard_error_url'] ?? '';
    $this->standard_output_content = $s['standard_output_content'] ?? '';
    $this->standard_output_url = $s['standard_output_url'] ?? '';
    $this->status = $s['status'] ?? '';
    $this->status_details = $s['status_details'] ?? '';
  }
...
class GetDeployablePatchSnapshotForInstanceResult {
  ...
  public function __construct(shape(
    ...
    $this->snapshot_download_url = $s['snapshot_download_url'] ?? '';
    $this->snapshot_id = $s['snapshot_id'] ?? '';
  }
}
...
class GetDocumentResult {
  ...
  public function __construct(shape(
    ...
    $this->attachments_content = $s['attachments_content'] ?? vec[];
    $this->content = $s['content'] ?? '';
    $this->document_format = $s['document_format'] ?? '';
    $this->document_type = $s['document_type'] ?? '';
    $this->document_version = $s['document_version'] ?? '';
...
class GetInventoryRequest {
  ...
  public function __construct(shape(
    ...
    $this->aggregators = $s['aggregators'] ?? vec[];
    $this->filters = $s['filters'] ?? vec[];
    $this->max_results = $s['max_results'] ?? 0;
    $this->next_token = $s['next_token'] ?? '';
    $this->result_attributes = $s['result_attributes'] ?? vec[];
  }
}
...
class GetInventorySchemaRequest {
  ...
  public function __construct(shape(
    ...
    $this->aggregator = $s['aggregator'] ?? false;
    $this->max_results = $s['max_results'] ?? 0;
    $this->next_token = $s['next_token'] ?? '';
    $this->sub_type = $s['sub_type'] ?? false;
    $this->type_name = $s['type_name'] ?? '';
  }
}
...
class GetMaintenanceWindowExecutionTaskInvocationRequest {
  ...
  public function __construct(shape(
    ...
    $this->invocation_id = $s['invocation_id'] ?? '';
    $this->task_id = $s['task_id'] ?? '';
    $this->window_execution_id = $s['window_execution_id'] ?? '';
  }
}
...
class GetMaintenanceWindowExecutionTaskInvocationResult {
  ...
  public function __construct(shape(
    ...
    $this->execution_id = $s['execution_id'] ?? '';
    $this->invocation_id = $s['invocation_id'] ?? '';
    $this->owner_information = $s['owner_information'] ?? '';
    $this->parameters = $s['parameters'] ?? '';
    $this->start_time = $s['start_time'] ?? 0;
    $this->status = $s['status'] ?? '';
    $this->status_details = $s['status_details'] ?? '';
    $this->task_execution_id = $s['task_execution_id'] ?? '';
...
class GetMaintenanceWindowExecutionTaskResult {
  ...
  public function __construct(shape(
    ...
    $this->task_execution_id = $s['task_execution_id'] ?? '';
    $this->task_parameters = $s['task_parameters'] ?? vec[];
    $this->type = $s['type'] ?? '';
    $this->window_execution_id = $s['window_execution_id'] ?? '';
  }
}
...
class GetMaintenanceWindowResult {
  ...
  public function __construct(shape(
    ...
    $this->end_date = $s['end_date'] ?? '';
    $this->modified_date = $s['modified_date'] ?? 0;
    $this->name = $s['name'] ?? '';
    $this->next_execution_time = $s['next_execution_time'] ?? '';
    $this->schedule = $s['schedule'] ?? '';
    $this->schedule_timezone = $s['schedule_timezone'] ?? '';
    $this->start_date = $s['start_date'] ?? '';
    $this->window_id = $s['window_id'] ?? '';
...
class GetMaintenanceWindowTaskResult {
  ...
  public function __construct(shape(
    ...
    $this->targets = $s['targets'] ?? vec[];
    $this->task_arn = $s['task_arn'] ?? '';
    $this->task_invocation_parameters = $s['task_invocation_parameters'] ?? null;
    $this->task_parameters = $s['task_parameters'] ?? dict[];
    $this->task_type = $s['task_type'] ?? '';
    $this->window_id = $s['window_id'] ?? '';
    $this->window_task_id = $s['window_task_id'] ?? '';
  }
...
class GetParameterHistoryRequest {
  ...
  public function __construct(shape(
    ...
    $this->name = $s['name'] ?? '';
    $this->next_token = $s['next_token'] ?? '';
    $this->with_decryption = $s['with_decryption'] ?? false;
  }
}
...
class GetParameterResult {
  ...
  public function __construct(shape(
    ...
    $this->parameter = $s['parameter'] ?? null;
  }
}
...
class GetPatchBaselineResult {
  ...
  public function __construct(shape(
    ...
    $this->name = $s['name'] ?? '';
    $this->operating_system = $s['operating_system'] ?? '';
    $this->patch_groups = $s['patch_groups'] ?? vec[];
    $this->rejected_patches = $s['rejected_patches'] ?? vec[];
    $this->rejected_patches_action = $s['rejected_patches_action'] ?? '';
    $this->sources = $s['sources'] ?? vec[];
  }
...
class GetServiceSettingResult {
  ...
  public function __construct(shape(
    ...
    $this->service_setting = $s['service_setting'] ?? null;
  }
}
...
class InstanceAggregatedAssociationOverview {
  ...
  public function __construct(shape(
    ...
    $this->detailed_status = $s['detailed_status'] ?? '';
    $this->instance_association_status_aggregated_count = $s['instance_association_status_aggregated_count'] ?? dict[];
  }
}
...
class InstanceAssociationOutputUrl {
  ...
  public function __construct(shape(
    ...
    $this->s_3_output_url = $s['s_3_output_url'] ?? null;
  }
}
...
class InstanceAssociationStatusInfo {
  ...
  public function __construct(shape(
    ...
    $this->execution_date = $s['execution_date'] ?? 0;
    $this->execution_summary = $s['execution_summary'] ?? '';
    $this->instance_id = $s['instance_id'] ?? '';
    $this->name = $s['name'] ?? '';
    $this->output_url = $s['output_url'] ?? null;
    $this->status = $s['status'] ?? '';
  }
}
...
class InstanceInformation {
  ...
  public function __construct(shape(
    ...
    $this->association_overview = $s['association_overview'] ?? null;
    $this->association_status = $s['association_status'] ?? '';
    $this->computer_name = $s['computer_name'] ?? '';
    $this->ip_address = $s['ip_address'] ?? '';
    $this->iam_role = $s['iam_role'] ?? '';
    $this->instance_id = $s['instance_id'] ?? '';
    $this->is_latest_version = $s['is_latest_version'] ?? false;
    $this->last_association_execution_date = $s['last_association_execution_date'] ?? 0;
    $this->last_ping_date_time = $s['last_ping_date_time'] ?? 0;
    $this->last_successful_association_execution_date = $s['last_successful_association_execution_date'] ?? 0;
    $this->name = $s['name'] ?? '';
    $this->ping_status = $s['ping_status'] ?? '';
    $this->platform_name = $s['platform_name'] ?? '';
    $this->platform_type = $s['platform_type'] ?? '';
    $this->platform_version = $s['platform_version'] ?? '';
    $this->registration_date = $s['registration_date'] ?? 0;
    $this->resource_type = $s['resource_type'] ?? '';
  }
}
...
class InstanceInformationFilter {
  ...
  public function __construct(shape(
    ...
    $this->key = $s['key'] ?? '';
    $this->value_set = $s['value_set'] ?? vec[];
  }
}
...
class InstancePatchState {
  ...
  public function __construct(shape(
    ...
    $this->install_override_list = $s['install_override_list'] ?? '';
    $this->installed_count = $s['installed_count'] ?? 0;
    $this->installed_other_count = $s['installed_other_count'] ?? 0;
    $this->installed_pending_reboot_count = $s['installed_pending_reboot_count'] ?? 0;
    $this->installed_rejected_count = $s['installed_rejected_count'] ?? 0;
    $this->instance_id = $s['instance_id'] ?? '';
    $this->last_no_reboot_install_operation_time = $s['last_no_reboot_install_operation_time'] ?? 0;
    $this->missing_count = $s['missing_count'] ?? 0;
    $this->not_applicable_count = $s['not_applicable_count'] ?? 0;
    $this->operation = $s['operation'] ?? '';
    $this->operation_end_time = $s['operation_end_time'] ?? 0;
    $this->operation_start_time = $s['operation_start_time'] ?? 0;
    $this->owner_information = $s['owner_information'] ?? '';
    $this->patch_group = $s['patch_group'] ?? '';
    $this->reboot_option = $s['reboot_option'] ?? '';
    $this->snapshot_id = $s['snapshot_id'] ?? '';
    $this->unreported_not_applicable_count = $s['unreported_not_applicable_count'] ?? 0;
  }
}
...
class InventoryDeletionStatusItem {
  ...
  public function __construct(shape(
    ...
    $this->deletion_id = $s['deletion_id'] ?? '';
    $this->deletion_start_time = $s['deletion_start_time'] ?? 0;
    $this->deletion_summary = $s['deletion_summary'] ?? null;
    $this->last_status = $s['last_status'] ?? '';
    $this->last_status_message = $s['last_status_message'] ?? '';
    $this->last_status_update_time = $s['last_status_update_time'] ?? 0;
    $this->type_name = $s['type_name'] ?? '';
  }
}
...
class InventoryDeletionSummary {
  ...
  public function __construct(shape(
    ...
    $this->remaining_count = $s['remaining_count'] ?? 0;
...
class InventoryItem {
  ...
  public function __construct(shape(
    ...
    $this->capture_time = $s['capture_time'] ?? '';
    $this->content = $s['content'] ?? vec[];
    $this->content_hash = $s['content_hash'] ?? '';
...
class LabelParameterVersionRequest {
  ...
  public function __construct(shape(
    ...
    $this->name = $s['name'] ?? '';
    $this->parameter_version = $s['parameter_version'] ?? 0;
  }
}
...
class LabelParameterVersionResult {
  ...
  public function __construct(shape(
    ...
    $this->invalid_labels = $s['invalid_labels'] ?? vec[];
    $this->parameter_version = $s['parameter_version'] ?? 0;
  }
}
...
class ListAssociationVersionsResult {
  ...
  public function __construct(shape(
    ...
    $this->association_versions = $s['association_versions'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListAssociationsRequest {
  ...
  public function __construct(shape(
    ...
    $this->association_filter_list = $s['association_filter_list'] ?? vec[];
    $this->max_results = $s['max_results'] ?? 0;
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListCommandInvocationsResult {
  ...
  public function __construct(shape(
    ...
    $this->command_invocations = $s['command_invocations'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListComplianceItemsResult {
  ...
  public function __construct(shape(
    ...
    $this->compliance_items = $s['compliance_items'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListComplianceSummariesResult {
  ...
  public function __construct(shape(
    ...
    $this->compliance_summary_items = $s['compliance_summary_items'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListDocumentsRequest {
  ...
  public function __construct(shape(
    ...
    $this->document_filter_list = $s['document_filter_list'] ?? vec[];
    $this->filters = $s['filters'] ?? vec[];
    $this->max_results = $s['max_results'] ?? 0;
    $this->next_token = $s['next_token'] ?? '';
  }
...
class ListDocumentsResult {
  ...
  public function __construct(shape(
    ...
    $this->document_identifiers = $s['document_identifiers'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListResourceComplianceSummariesResult {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->resource_compliance_summary_items = $s['resource_compliance_summary_items'] ?? vec[];
  }
}
...
class ListResourceDataSyncResult {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->resource_data_sync_items = $s['resource_data_sync_items'] ?? vec[];
  }
}
...
class MaintenanceWindowRunCommandParameters {
  ...
  public function __construct(shape(
    ...
    $this->cloud_watch_output_config = $s['cloud_watch_output_config'] ?? null;
    $this->comment = $s['comment'] ?? '';
    $this->document_hash = $s['document_hash'] ?? '';
    $this->document_hash_type = $s['document_hash_type'] ?? '';
    $this->document_version = $s['document_version'] ?? '';
    $this->notification_config = $s['notification_config'] ?? null;
    $this->output_s_3_bucket_name = $s['output_s_3_bucket_name'] ?? '';
    $this->output_s_3_key_prefix = $s['output_s_3_key_prefix'] ?? '';
    $this->parameters = $s['parameters'] ?? dict[];
    $this->service_role_arn = $s['service_role_arn'] ?? '';
    $this->timeout_seconds = $s['timeout_seconds'] ?? 0;
  }
}
...
class MaintenanceWindowTaskInvocationParameters {
  ...
  public function __construct(shape(
    ...
    $this->automation = $s['automation'] ?? null;
    $this->lambda = $s['lambda'] ?? null;
    $this->run_command = $s['run_command'] ?? null;
...
class ModifyDocumentPermissionRequest {
  ...
  public function __construct(shape(
    ...
    $this->account_ids_to_add = $s['account_ids_to_add'] ?? vec[];
    $this->account_ids_to_remove = $s['account_ids_to_remove'] ?? vec[];
    $this->name = $s['name'] ?? '';
    $this->permission_type = $s['permission_type'] ?? '';
    $this->shared_document_version = $s['shared_document_version'] ?? '';
  }
...
class NonCompliantSummary {
  ...
  public function __construct(shape(
    ...
    $this->non_compliant_count = $s['non_compliant_count'] ?? 0;
    $this->severity_summary = $s['severity_summary'] ?? null;
  }
}
...
class NotificationConfig {
  ...
  public function __construct(shape(
    ...
    $this->notification_arn = $s['notification_arn'] ?? '';
    $this->notification_events = $s['notification_events'] ?? vec[];
...
class OpsAggregator {
  ...
  public function __construct(shape(
    ...
    $this->aggregator_type = $s['aggregator_type'] ?? '';
    $this->aggregators = $s['aggregators'] ?? vec[];
    $this->attribute_name = $s['attribute_name'] ?? '';
    $this->filters = $s['filters'] ?? vec[];
    $this->type_name = $s['type_name'] ?? '';
    $this->values = $s['values'] ?? dict[];
  }
}
...
class OpsItemInvalidParameterException {
  ...
  public function __construct(shape(
    ...
    $this->message = $s['message'] ?? '';
    $this->parameter_names = $s['parameter_names'] ?? vec[];
  }
}
...
class OutputSource {
  ...
  public function __construct(shape(
    ...
    $this->output_source_id = $s['output_source_id'] ?? '';
    $this->output_source_type = $s['output_source_type'] ?? '';
  }
}
...
class Parameter {
  ...
  public function __construct(shape(
    ...
    $this->source_result = $s['source_result'] ?? '';
    $this->type = $s['type'] ?? '';
    $this->value = $s['value'] ?? '';
...
class ParameterInlinePolicy {
  ...
  public function __construct(shape(
    ...
    $this->policy_status = $s['policy_status'] ?? '';
...
class Patch {
  ...
  public function __construct(shape(
    ...
    $this->content_url = $s['content_url'] ?? '';
    $this->description = $s['description'] ?? '';
    $this->id = $s['id'] ?? '';
    $this->kb_number = $s['kb_number'] ?? '';
    $this->language = $s['language'] ?? '';
    $this->msrc_number = $s['msrc_number'] ?? '';
    $this->msrc_severity = $s['msrc_severity'] ?? '';
    $this->product = $s['product'] ?? '';
    $this->product_family = $s['product_family'] ?? '';
...
class PatchBaselineIdentity {
  ...
  public function __construct(shape(
    ...
    $this->baseline_description = $s['baseline_description'] ?? '';
    $this->baseline_id = $s['baseline_id'] ?? '';
    $this->baseline_name = $s['baseline_name'] ?? '';
    $this->default_baseline = $s['default_baseline'] ?? false;
    $this->operating_system = $s['operating_system'] ?? '';
  }
}
...
class PatchComplianceData {
  ...
  public function __construct(shape(
    ...
    $this->classification = $s['classification'] ?? '';
    $this->installed_time = $s['installed_time'] ?? 0;
    $this->kb_id = $s['kb_id'] ?? '';
    $this->severity = $s['severity'] ?? '';
    $this->state = $s['state'] ?? '';
    $this->title = $s['title'] ?? '';
...
class PatchFilterGroup {
  ...
  public function __construct(shape(
    ...
    $this->patch_filters = $s['patch_filters'] ?? vec[];
  }
}
...
class PatchGroupPatchBaselineMapping {
  ...
  public function __construct(shape(
    ...
    $this->baseline_identity = $s['baseline_identity'] ?? null;
    $this->patch_group = $s['patch_group'] ?? '';
  }
}
...
class PatchRule {
  ...
  public bool $enable_non_security;
  ...
  public function __construct(shape(
    ...
    $this->approve_after_days = $s['approve_after_days'] ?? 0;
    $this->approve_until_date = $s['approve_until_date'] ?? '';
    $this->compliance_level = $s['compliance_level'] ?? '';
    $this->enable_non_security = $s['enable_non_security'] ?? false;
    $this->patch_filter_group = $s['patch_filter_group'] ?? null;
  }
}
...
class PatchRuleGroup {
  ...
  public function __construct(shape(
    ...
    $this->patch_rules = $s['patch_rules'] ?? vec[];
  }
}
...
class PatchStatus {
  ...
  public function __construct(shape(
    ...
    $this->approval_date = $s['approval_date'] ?? 0;
    $this->compliance_level = $s['compliance_level'] ?? '';
...
class ProgressCounters {
  ...
  public function __construct(shape(
    ...
    $this->cancelled_steps = $s['cancelled_steps'] ?? 0;
    $this->failed_steps = $s['failed_steps'] ?? 0;
    $this->success_steps = $s['success_steps'] ?? 0;
    $this->timed_out_steps = $s['timed_out_steps'] ?? 0;
    $this->total_steps = $s['total_steps'] ?? 0;
  }
}
...
class PutComplianceItemsRequest {
  ...
  public function __construct(shape(
    ...
    $this->compliance_type = $s['compliance_type'] ?? '';
    $this->execution_summary = $s['execution_summary'] ?? null;
    $this->item_content_hash = $s['item_content_hash'] ?? '';
...
class ResourceComplianceSummaryItem {
  ...
  public function __construct(shape(
    ...
    $this->execution_summary = $s['execution_summary'] ?? null;
    $this->non_compliant_summary = $s['non_compliant_summary'] ?? null;
    $this->overall_severity = $s['overall_severity'] ?? '';
    $this->resource_id = $s['resource_id'] ?? '';
    $this->resource_type = $s['resource_type'] ?? '';
    $this->status = $s['status'] ?? '';
  }
...
class ResourceDataSyncAwsOrganizationsSource {
  ...
  public function __construct(shape(
    ...
    $this->organization_source_type = $s['organization_source_type'] ?? '';
...
class ResourceDataSyncDestinationDataSharing {
  ...
  public function __construct(shape(
    ...
    $this->destination_data_sharing_type = $s['destination_data_sharing_type'] ?? '';
  }
}
...
class ResourceDataSyncItem {
  ...
  public function __construct(shape(
    ...
    $this->last_status = $s['last_status'] ?? '';
    $this->last_successful_sync_time = $s['last_successful_sync_time'] ?? 0;
    $this->last_sync_status_message = $s['last_sync_status_message'] ?? '';
    $this->last_sync_time = $s['last_sync_time'] ?? 0;
    $this->s_3_destination = $s['s_3_destination'] ?? null;
    $this->sync_created_time = $s['sync_created_time'] ?? 0;
    $this->sync_last_modified_time = $s['sync_last_modified_time'] ?? 0;
    $this->sync_name = $s['sync_name'] ?? '';
    $this->sync_source = $s['sync_source'] ?? null;
    $this->sync_type = $s['sync_type'] ?? '';
  }
...
class ResourceDataSyncS3Destination {
  ...
  public function __construct(shape(
    ...
    $this->destination_data_sharing = $s['destination_data_sharing'] ?? null;
    $this->prefix = $s['prefix'] ?? '';
    $this->region = $s['region'] ?? '';
    $this->sync_format = $s['sync_format'] ?? '';
  }
}
...
class ResourceDataSyncSource {
  ...
  public function __construct(shape(
    ...
    $this->aws_organizations_source = $s['aws_organizations_source'] ?? null;
    $this->include_future_regions = $s['include_future_regions'] ?? false;
...
class ResumeSessionResponse {
  ...
  public function __construct(shape(
    ...
    $this->session_id = $s['session_id'] ?? '';
    $this->stream_url = $s['stream_url'] ?? '';
    $this->token_value = $s['token_value'] ?? '';
  }
}
...
class SendAutomationSignalRequest {
  ...
  public function __construct(shape(
    ...
    $this->automation_execution_id = $s['automation_execution_id'] ?? '';
    $this->payload = $s['payload'] ?? dict[];
    $this->signal_type = $s['signal_type'] ?? '';
  }
}
...
class ServiceSetting {
  ...
  public function __construct(shape(
    ...
    $this->last_modified_user = $s['last_modified_user'] ?? '';
    $this->setting_id = $s['setting_id'] ?? '';
    $this->setting_value = $s['setting_value'] ?? '';
    $this->status = $s['status'] ?? '';
  }
}
...
class SessionManagerOutputUrl {
  ...
  public function __construct(shape(
    ...
    $this->cloud_watch_output_url = $s['cloud_watch_output_url'] ?? '';
    $this->s_3_output_url = $s['s_3_output_url'] ?? '';
  }
}
...
class SeveritySummary {
  ...
  public function __construct(shape(
    ...
    $this->critical_count = $s['critical_count'] ?? 0;
    $this->high_count = $s['high_count'] ?? 0;
    $this->informational_count = $s['informational_count'] ?? 0;
    $this->low_count = $s['low_count'] ?? 0;
    $this->medium_count = $s['medium_count'] ?? 0;
    $this->unspecified_count = $s['unspecified_count'] ?? 0;
  }
}
...
class StepExecution {
  ...
  public function __construct(shape(
    ...
    $this->failure_message = $s['failure_message'] ?? '';
    $this->inputs = $s['inputs'] ?? dict[];
    $this->is_critical = $s['is_critical'] ?? false;
    $this->is_end = $s['is_end'] ?? false;
    $this->max_attempts = $s['max_attempts'] ?? 0;
    $this->next_step = $s['next_step'] ?? '';
    $this->on_failure = $s['on_failure'] ?? '';
    $this->outputs = $s['outputs'] ?? dict[];
    $this->overridden_parameters = $s['overridden_parameters'] ?? dict[];
    $this->response = $s['response'] ?? '';
    $this->response_code = $s['response_code'] ?? '';
    $this->step_execution_id = $s['step_execution_id'] ?? '';
    $this->step_name = $s['step_name'] ?? '';
    $this->step_status = $s['step_status'] ?? '';
    $this->target_location = $s['target_location'] ?? null;
    $this->targets = $s['targets'] ?? vec[];
    $this->timeout_seconds = $s['timeout_seconds'] ?? 0;
    $this->valid_next_steps = $s['valid_next_steps'] ?? vec[];
  }
}
...
class TargetLocation {
  ...
  public function __construct(shape(
    ...
    $this->target_location_max_concurrency = $s['target_location_max_concurrency'] ?? '';
    $this->target_location_max_errors = $s['target_location_max_errors'] ?? '';
  }
}
...
class UpdateAssociationStatusRequest {
  ...
  public function __construct(shape(
    ...
    $this->association_status = $s['association_status'] ?? null;
    $this->instance_id = $s['instance_id'] ?? '';
    $this->name = $s['name'] ?? '';
  }
}
...
class UpdateOpsItemRequest {
  ...
  public function __construct(shape(
    ...
    $this->notifications = $s['notifications'] ?? vec[];
    $this->operational_data = $s['operational_data'] ?? dict[];
    $this->operational_data_to_delete = $s['operational_data_to_delete'] ?? vec[];
    $this->ops_item_id = $s['ops_item_id'] ?? '';
    $this->priority = $s['priority'] ?? 0;
    $this->related_ops_items = $s['related_ops_items'] ?? vec[];
    $this->severity = $s['severity'] ?? '';
