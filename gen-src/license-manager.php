...
interface LicenseManager {
  public function CreateLicenseConfiguration(CreateLicenseConfigurationRequest $in): Awaitable<\Errors\Result<CreateLicenseConfigurationResponse>>;
  public function DeleteLicenseConfiguration(DeleteLicenseConfigurationRequest $in): Awaitable<\Errors\Result<DeleteLicenseConfigurationResponse>>;
  public function GetLicenseConfiguration(GetLicenseConfigurationRequest $in): Awaitable<\Errors\Result<GetLicenseConfigurationResponse>>;
  public function GetServiceSettings(GetServiceSettingsRequest $in): Awaitable<\Errors\Result<GetServiceSettingsResponse>>;
  public function ListAssociationsForLicenseConfiguration(ListAssociationsForLicenseConfigurationRequest $in): Awaitable<\Errors\Result<ListAssociationsForLicenseConfigurationResponse>>;
  public function ListFailuresForLicenseConfigurationOperations(ListFailuresForLicenseConfigurationOperationsRequest $in): Awaitable<\Errors\Result<ListFailuresForLicenseConfigurationOperationsResponse>>;
  public function ListLicenseConfigurations(ListLicenseConfigurationsRequest $in): Awaitable<\Errors\Result<ListLicenseConfigurationsResponse>>;
  public function ListLicenseSpecificationsForResource(ListLicenseSpecificationsForResourceRequest $in): Awaitable<\Errors\Result<ListLicenseSpecificationsForResourceResponse>>;
  public function ListResourceInventory(ListResourceInventoryRequest $in): Awaitable<\Errors\Result<ListResourceInventoryResponse>>;
  public function ListTagsForResource(ListTagsForResourceRequest $in): Awaitable<\Errors\Result<ListTagsForResourceResponse>>;
  public function ListUsageForLicenseConfiguration(ListUsageForLicenseConfigurationRequest $in): Awaitable<\Errors\Result<ListUsageForLicenseConfigurationResponse>>;
  ...
  public function UpdateLicenseConfiguration(UpdateLicenseConfigurationRequest $in): Awaitable<\Errors\Result<UpdateLicenseConfigurationResponse>>;
  public function UpdateLicenseSpecificationsForResource(UpdateLicenseSpecificationsForResourceRequest $in): Awaitable<\Errors\Result<UpdateLicenseSpecificationsForResourceResponse>>;
  public function UpdateServiceSettings(UpdateServiceSettingsRequest $in): Awaitable<\Errors\Result<UpdateServiceSettingsResponse>>;
}
...
class AutomatedDiscoveryInformation {
  ...
  public function __construct(shape(
    ...
    $this->last_run_time = $s['last_run_time'] ?? 0;
  }
}
...
class ConsumedLicenseSummary {
  ...
  public function __construct(shape(
    ...
    $this->consumed_licenses = $s['consumed_licenses'] ?? 0;
...
class CreateLicenseConfigurationRequest {
  ...
  public function __construct(shape(
    ...
    $this->license_count = $s['license_count'] ?? 0;
    $this->license_count_hard_limit = $s['license_count_hard_limit'] ?? false;
    $this->license_counting_type = $s['license_counting_type'] ?? '';
    $this->license_rules = $s['license_rules'] ?? vec[];
    $this->name = $s['name'] ?? '';
    $this->product_information_list = $s['product_information_list'] ?? vec[];
...
class GetLicenseConfigurationResponse {
  ...
  public function __construct(shape(
    ...
    $this->automated_discovery_information = $s['automated_discovery_information'] ?? null;
    $this->consumed_license_summary_list = $s['consumed_license_summary_list'] ?? vec[];
    $this->consumed_licenses = $s['consumed_licenses'] ?? 0;
    $this->description = $s['description'] ?? '';
    $this->license_configuration_arn = $s['license_configuration_arn'] ?? '';
    $this->license_configuration_id = $s['license_configuration_id'] ?? '';
    $this->license_count = $s['license_count'] ?? 0;
    $this->license_count_hard_limit = $s['license_count_hard_limit'] ?? false;
    $this->license_counting_type = $s['license_counting_type'] ?? '';
    $this->license_rules = $s['license_rules'] ?? vec[];
    $this->managed_resource_summary_list = $s['managed_resource_summary_list'] ?? vec[];
    $this->name = $s['name'] ?? '';
...
class GetServiceSettingsResponse {
  ...
  public function __construct(shape(
    ...
    $this->enable_cross_accounts_discovery = $s['enable_cross_accounts_discovery'] ?? false;
    $this->license_manager_resource_share_arn = $s['license_manager_resource_share_arn'] ?? '';
    $this->organization_configuration = $s['organization_configuration'] ?? null;
...
class LicenseConfigurationAssociation {
  ...
  public function __construct(shape(
    ...
    $this->association_time = $s['association_time'] ?? 0;
...
class LicenseOperationFailure {
  ...
  public function __construct(shape(
    ...
    $this->failure_time = $s['failure_time'] ?? 0;
    $this->metadata_list = $s['metadata_list'] ?? vec[];
    $this->operation_name = $s['operation_name'] ?? '';
    $this->operation_requested_by = $s['operation_requested_by'] ?? '';
    $this->resource_arn = $s['resource_arn'] ?? '';
    $this->resource_owner_id = $s['resource_owner_id'] ?? '';
    $this->resource_type = $s['resource_type'] ?? '';
  }
...
class ListAssociationsForLicenseConfigurationResponse {
  ...
  public function __construct(shape(
    ...
    $this->license_configuration_associations = $s['license_configuration_associations'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListFailuresForLicenseConfigurationOperationsResponse {
  ...
  public function __construct(shape(
    ...
    $this->license_operation_failure_list = $s['license_operation_failure_list'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListLicenseConfigurationsResponse {
  ...
  public function __construct(shape(
    ...
    $this->license_configurations = $s['license_configurations'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListResourceInventoryResponse {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->resource_inventory_list = $s['resource_inventory_list'] ?? vec[];
  }
}
...
class ListUsageForLicenseConfigurationResponse {
  ...
  public function __construct(shape(
    ...
    $this->license_configuration_usage_list = $s['license_configuration_usage_list'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ManagedResourceSummary {
  ...
  public function __construct(shape(
    ...
    $this->association_count = $s['association_count'] ?? 0;
    $this->resource_type = $s['resource_type'] ?? '';
  }
}
...
class OrganizationConfiguration {
  ...
  public function __construct(shape(
    ...
    $this->enable_integration = $s['enable_integration'] ?? false;
  }
}
...
class ProductInformation {
  ...
  public function __construct(shape(
    ...
    $this->product_information_filter_list = $s['product_information_filter_list'] ?? vec[];
    $this->resource_type = $s['resource_type'] ?? '';
  }
}
...
class ProductInformationFilter {
  ...
  public function __construct(shape(
    ...
    $this->product_information_filter_comparator = $s['product_information_filter_comparator'] ?? '';
    $this->product_information_filter_name = $s['product_information_filter_name'] ?? '';
    $this->product_information_filter_value = $s['product_information_filter_value'] ?? vec[];
  }
}
...
class ResourceInventory {
  ...
  public function __construct(shape(
    ...
    $this->resource_owning_account_id = $s['resource_owning_account_id'] ?? '';
    $this->resource_type = $s['resource_type'] ?? '';
  }
}
...
class UpdateLicenseConfigurationRequest {
  ...
  public function __construct(shape(
    ...
    $this->description = $s['description'] ?? '';
    $this->license_configuration_arn = $s['license_configuration_arn'] ?? '';
    $this->license_configuration_status = $s['license_configuration_status'] ?? '';
    $this->license_count = $s['license_count'] ?? 0;
    $this->license_count_hard_limit = $s['license_count_hard_limit'] ?? false;
    $this->license_rules = $s['license_rules'] ?? vec[];
    $this->name = $s['name'] ?? '';
...
class UpdateLicenseSpecificationsForResourceRequest {
  ...
  public function __construct(shape(
    ...
    $this->add_license_specifications = $s['add_license_specifications'] ?? vec[];
    $this->remove_license_specifications = $s['remove_license_specifications'] ?? vec[];
    $this->resource_arn = $s['resource_arn'] ?? '';
  }
}
