...
interface Chime {
  public function AssociatePhoneNumberWithUser(AssociatePhoneNumberWithUserRequest $in): Awaitable<\Errors\Result<AssociatePhoneNumberWithUserResponse>>;
  public function AssociatePhoneNumbersWithVoiceConnector(AssociatePhoneNumbersWithVoiceConnectorRequest $in): Awaitable<\Errors\Result<AssociatePhoneNumbersWithVoiceConnectorResponse>>;
  public function AssociatePhoneNumbersWithVoiceConnectorGroup(AssociatePhoneNumbersWithVoiceConnectorGroupRequest $in): Awaitable<\Errors\Result<AssociatePhoneNumbersWithVoiceConnectorGroupResponse>>;
  public function AssociateSigninDelegateGroupsWithAccount(AssociateSigninDelegateGroupsWithAccountRequest $in): Awaitable<\Errors\Result<AssociateSigninDelegateGroupsWithAccountResponse>>;
  public function BatchCreateAttendee(BatchCreateAttendeeRequest $in): Awaitable<\Errors\Result<BatchCreateAttendeeResponse>>;
  public function BatchCreateRoomMembership(BatchCreateRoomMembershipRequest $in): Awaitable<\Errors\Result<BatchCreateRoomMembershipResponse>>;
  public function BatchDeletePhoneNumber(BatchDeletePhoneNumberRequest $in): Awaitable<\Errors\Result<BatchDeletePhoneNumberResponse>>;
  public function BatchSuspendUser(BatchSuspendUserRequest $in): Awaitable<\Errors\Result<BatchSuspendUserResponse>>;
  public function BatchUnsuspendUser(BatchUnsuspendUserRequest $in): Awaitable<\Errors\Result<BatchUnsuspendUserResponse>>;
  public function BatchUpdatePhoneNumber(BatchUpdatePhoneNumberRequest $in): Awaitable<\Errors\Result<BatchUpdatePhoneNumberResponse>>;
  public function BatchUpdateUser(BatchUpdateUserRequest $in): Awaitable<\Errors\Result<BatchUpdateUserResponse>>;
  public function CreateAccount(CreateAccountRequest $in): Awaitable<\Errors\Result<CreateAccountResponse>>;
  public function CreateAttendee(CreateAttendeeRequest $in): Awaitable<\Errors\Result<CreateAttendeeResponse>>;
  public function CreateBot(CreateBotRequest $in): Awaitable<\Errors\Result<CreateBotResponse>>;
  public function CreateMeeting(CreateMeetingRequest $in): Awaitable<\Errors\Result<CreateMeetingResponse>>;
  public function CreatePhoneNumberOrder(CreatePhoneNumberOrderRequest $in): Awaitable<\Errors\Result<CreatePhoneNumberOrderResponse>>;
  public function CreateProxySession(CreateProxySessionRequest $in): Awaitable<\Errors\Result<CreateProxySessionResponse>>;
  public function CreateRoom(CreateRoomRequest $in): Awaitable<\Errors\Result<CreateRoomResponse>>;
  public function CreateRoomMembership(CreateRoomMembershipRequest $in): Awaitable<\Errors\Result<CreateRoomMembershipResponse>>;
  public function CreateUser(CreateUserRequest $in): Awaitable<\Errors\Result<CreateUserResponse>>;
  public function CreateVoiceConnector(CreateVoiceConnectorRequest $in): Awaitable<\Errors\Result<CreateVoiceConnectorResponse>>;
  public function CreateVoiceConnectorGroup(CreateVoiceConnectorGroupRequest $in): Awaitable<\Errors\Result<CreateVoiceConnectorGroupResponse>>;
  public function DeleteAccount(DeleteAccountRequest $in): Awaitable<\Errors\Result<DeleteAccountResponse>>;
  public function DeleteAttendee(DeleteAttendeeRequest $in): Awaitable<\Errors\Error>;
  public function DeleteEventsConfiguration(DeleteEventsConfigurationRequest $in): Awaitable<\Errors\Error>;
  public function DeleteMeeting(DeleteMeetingRequest $in): Awaitable<\Errors\Error>;
  public function DeletePhoneNumber(DeletePhoneNumberRequest $in): Awaitable<\Errors\Error>;
  public function DeleteProxySession(DeleteProxySessionRequest $in): Awaitable<\Errors\Error>;
  public function DeleteRoom(DeleteRoomRequest $in): Awaitable<\Errors\Error>;
  public function DeleteRoomMembership(DeleteRoomMembershipRequest $in): Awaitable<\Errors\Error>;
  public function DeleteVoiceConnector(DeleteVoiceConnectorRequest $in): Awaitable<\Errors\Error>;
  public function DeleteVoiceConnectorGroup(DeleteVoiceConnectorGroupRequest $in): Awaitable<\Errors\Error>;
  public function DeleteVoiceConnectorOrigination(DeleteVoiceConnectorOriginationRequest $in): Awaitable<\Errors\Error>;
  public function DeleteVoiceConnectorProxy(DeleteVoiceConnectorProxyRequest $in): Awaitable<\Errors\Error>;
  public function DeleteVoiceConnectorStreamingConfiguration(DeleteVoiceConnectorStreamingConfigurationRequest $in): Awaitable<\Errors\Error>;
  public function DeleteVoiceConnectorTermination(DeleteVoiceConnectorTerminationRequest $in): Awaitable<\Errors\Error>;
  public function DeleteVoiceConnectorTerminationCredentials(DeleteVoiceConnectorTerminationCredentialsRequest $in): Awaitable<\Errors\Error>;
  public function DisassociatePhoneNumberFromUser(DisassociatePhoneNumberFromUserRequest $in): Awaitable<\Errors\Result<DisassociatePhoneNumberFromUserResponse>>;
  public function DisassociatePhoneNumbersFromVoiceConnector(DisassociatePhoneNumbersFromVoiceConnectorRequest $in): Awaitable<\Errors\Result<DisassociatePhoneNumbersFromVoiceConnectorResponse>>;
  public function DisassociatePhoneNumbersFromVoiceConnectorGroup(DisassociatePhoneNumbersFromVoiceConnectorGroupRequest $in): Awaitable<\Errors\Result<DisassociatePhoneNumbersFromVoiceConnectorGroupResponse>>;
  public function DisassociateSigninDelegateGroupsFromAccount(DisassociateSigninDelegateGroupsFromAccountRequest $in): Awaitable<\Errors\Result<DisassociateSigninDelegateGroupsFromAccountResponse>>;
  ...
  public function GetAttendee(GetAttendeeRequest $in): Awaitable<\Errors\Result<GetAttendeeResponse>>;
  public function GetBot(GetBotRequest $in): Awaitable<\Errors\Result<GetBotResponse>>;
  public function GetEventsConfiguration(GetEventsConfigurationRequest $in): Awaitable<\Errors\Result<GetEventsConfigurationResponse>>;
  public function GetGlobalSettings( $in): Awaitable<\Errors\Result<GetGlobalSettingsResponse>>;
  public function GetMeeting(GetMeetingRequest $in): Awaitable<\Errors\Result<GetMeetingResponse>>;
  public function GetPhoneNumber(GetPhoneNumberRequest $in): Awaitable<\Errors\Result<GetPhoneNumberResponse>>;
  public function GetPhoneNumberOrder(GetPhoneNumberOrderRequest $in): Awaitable<\Errors\Result<GetPhoneNumberOrderResponse>>;
  public function GetPhoneNumberSettings( $in): Awaitable<\Errors\Result<GetPhoneNumberSettingsResponse>>;
  public function GetProxySession(GetProxySessionRequest $in): Awaitable<\Errors\Result<GetProxySessionResponse>>;
  ...
  public function GetUserSettings(GetUserSettingsRequest $in): Awaitable<\Errors\Result<GetUserSettingsResponse>>;
  public function GetVoiceConnector(GetVoiceConnectorRequest $in): Awaitable<\Errors\Result<GetVoiceConnectorResponse>>;
  public function GetVoiceConnectorGroup(GetVoiceConnectorGroupRequest $in): Awaitable<\Errors\Result<GetVoiceConnectorGroupResponse>>;
  public function GetVoiceConnectorLoggingConfiguration(GetVoiceConnectorLoggingConfigurationRequest $in): Awaitable<\Errors\Result<GetVoiceConnectorLoggingConfigurationResponse>>;
  public function GetVoiceConnectorOrigination(GetVoiceConnectorOriginationRequest $in): Awaitable<\Errors\Result<GetVoiceConnectorOriginationResponse>>;
  public function GetVoiceConnectorProxy(GetVoiceConnectorProxyRequest $in): Awaitable<\Errors\Result<GetVoiceConnectorProxyResponse>>;
  public function GetVoiceConnectorStreamingConfiguration(GetVoiceConnectorStreamingConfigurationRequest $in): Awaitable<\Errors\Result<GetVoiceConnectorStreamingConfigurationResponse>>;
  public function GetVoiceConnectorTermination(GetVoiceConnectorTerminationRequest $in): Awaitable<\Errors\Result<GetVoiceConnectorTerminationResponse>>;
  public function GetVoiceConnectorTerminationHealth(GetVoiceConnectorTerminationHealthRequest $in): Awaitable<\Errors\Result<GetVoiceConnectorTerminationHealthResponse>>;
  public function InviteUsers(InviteUsersRequest $in): Awaitable<\Errors\Result<InviteUsersResponse>>;
  public function ListAccounts(ListAccountsRequest $in): Awaitable<\Errors\Result<ListAccountsResponse>>;
  public function ListAttendeeTags(ListAttendeeTagsRequest $in): Awaitable<\Errors\Result<ListAttendeeTagsResponse>>;
  public function ListAttendees(ListAttendeesRequest $in): Awaitable<\Errors\Result<ListAttendeesResponse>>;
  public function ListBots(ListBotsRequest $in): Awaitable<\Errors\Result<ListBotsResponse>>;
  public function ListMeetingTags(ListMeetingTagsRequest $in): Awaitable<\Errors\Result<ListMeetingTagsResponse>>;
  public function ListMeetings(ListMeetingsRequest $in): Awaitable<\Errors\Result<ListMeetingsResponse>>;
  public function ListPhoneNumberOrders(ListPhoneNumberOrdersRequest $in): Awaitable<\Errors\Result<ListPhoneNumberOrdersResponse>>;
  public function ListPhoneNumbers(ListPhoneNumbersRequest $in): Awaitable<\Errors\Result<ListPhoneNumbersResponse>>;
  public function ListProxySessions(ListProxySessionsRequest $in): Awaitable<\Errors\Result<ListProxySessionsResponse>>;
  public function ListRoomMemberships(ListRoomMembershipsRequest $in): Awaitable<\Errors\Result<ListRoomMembershipsResponse>>;
  public function ListRooms(ListRoomsRequest $in): Awaitable<\Errors\Result<ListRoomsResponse>>;
  public function ListTagsForResource(ListTagsForResourceRequest $in): Awaitable<\Errors\Result<ListTagsForResourceResponse>>;
  public function ListUsers(ListUsersRequest $in): Awaitable<\Errors\Result<ListUsersResponse>>;
  public function ListVoiceConnectorGroups(ListVoiceConnectorGroupsRequest $in): Awaitable<\Errors\Result<ListVoiceConnectorGroupsResponse>>;
  public function ListVoiceConnectorTerminationCredentials(ListVoiceConnectorTerminationCredentialsRequest $in): Awaitable<\Errors\Result<ListVoiceConnectorTerminationCredentialsResponse>>;
  public function ListVoiceConnectors(ListVoiceConnectorsRequest $in): Awaitable<\Errors\Result<ListVoiceConnectorsResponse>>;
  public function LogoutUser(LogoutUserRequest $in): Awaitable<\Errors\Result<LogoutUserResponse>>;
  public function PutEventsConfiguration(PutEventsConfigurationRequest $in): Awaitable<\Errors\Result<PutEventsConfigurationResponse>>;
  public function PutVoiceConnectorLoggingConfiguration(PutVoiceConnectorLoggingConfigurationRequest $in): Awaitable<\Errors\Result<PutVoiceConnectorLoggingConfigurationResponse>>;
  public function PutVoiceConnectorOrigination(PutVoiceConnectorOriginationRequest $in): Awaitable<\Errors\Result<PutVoiceConnectorOriginationResponse>>;
  public function PutVoiceConnectorProxy(PutVoiceConnectorProxyRequest $in): Awaitable<\Errors\Result<PutVoiceConnectorProxyResponse>>;
  public function PutVoiceConnectorStreamingConfiguration(PutVoiceConnectorStreamingConfigurationRequest $in): Awaitable<\Errors\Result<PutVoiceConnectorStreamingConfigurationResponse>>;
  public function PutVoiceConnectorTermination(PutVoiceConnectorTerminationRequest $in): Awaitable<\Errors\Result<PutVoiceConnectorTerminationResponse>>;
  public function PutVoiceConnectorTerminationCredentials(PutVoiceConnectorTerminationCredentialsRequest $in): Awaitable<\Errors\Error>;
  public function RegenerateSecurityToken(RegenerateSecurityTokenRequest $in): Awaitable<\Errors\Result<RegenerateSecurityTokenResponse>>;
  public function ResetPersonalPIN(ResetPersonalPINRequest $in): Awaitable<\Errors\Result<ResetPersonalPINResponse>>;
  public function RestorePhoneNumber(RestorePhoneNumberRequest $in): Awaitable<\Errors\Result<RestorePhoneNumberResponse>>;
  public function SearchAvailablePhoneNumbers(SearchAvailablePhoneNumbersRequest $in): Awaitable<\Errors\Result<SearchAvailablePhoneNumbersResponse>>;
  public function TagAttendee(TagAttendeeRequest $in): Awaitable<\Errors\Error>;
  public function TagMeeting(TagMeetingRequest $in): Awaitable<\Errors\Error>;
  public function TagResource(TagResourceRequest $in): Awaitable<\Errors\Error>;
  public function UntagAttendee(UntagAttendeeRequest $in): Awaitable<\Errors\Error>;
  public function UntagMeeting(UntagMeetingRequest $in): Awaitable<\Errors\Error>;
  public function UntagResource(UntagResourceRequest $in): Awaitable<\Errors\Error>;
  public function UpdateAccount(UpdateAccountRequest $in): Awaitable<\Errors\Result<UpdateAccountResponse>>;
  public function UpdateAccountSettings(UpdateAccountSettingsRequest $in): Awaitable<\Errors\Result<UpdateAccountSettingsResponse>>;
  public function UpdateBot(UpdateBotRequest $in): Awaitable<\Errors\Result<UpdateBotResponse>>;
  public function UpdateGlobalSettings(UpdateGlobalSettingsRequest $in): Awaitable<\Errors\Error>;
  public function UpdatePhoneNumber(UpdatePhoneNumberRequest $in): Awaitable<\Errors\Result<UpdatePhoneNumberResponse>>;
  public function UpdatePhoneNumberSettings(UpdatePhoneNumberSettingsRequest $in): Awaitable<\Errors\Error>;
  public function UpdateProxySession(UpdateProxySessionRequest $in): Awaitable<\Errors\Result<UpdateProxySessionResponse>>;
  public function UpdateRoom(UpdateRoomRequest $in): Awaitable<\Errors\Result<UpdateRoomResponse>>;
  public function UpdateRoomMembership(UpdateRoomMembershipRequest $in): Awaitable<\Errors\Result<UpdateRoomMembershipResponse>>;
  public function UpdateUser(UpdateUserRequest $in): Awaitable<\Errors\Result<UpdateUserResponse>>;
  public function UpdateUserSettings(UpdateUserSettingsRequest $in): Awaitable<\Errors\Error>;
  public function UpdateVoiceConnector(UpdateVoiceConnectorRequest $in): Awaitable<\Errors\Result<UpdateVoiceConnectorResponse>>;
  public function UpdateVoiceConnectorGroup(UpdateVoiceConnectorGroupRequest $in): Awaitable<\Errors\Result<UpdateVoiceConnectorGroupResponse>>;
}
...
class Account {
  ...
  public function __construct(shape(
    ...
    $this->account_type = $s['account_type'] ?? '';
    $this->aws_account_id = $s['aws_account_id'] ?? '';
    $this->created_timestamp = $s['created_timestamp'] ?? 0;
    $this->default_license = $s['default_license'] ?? '';
    $this->name = $s['name'] ?? '';
    $this->signin_delegate_groups = $s['signin_delegate_groups'] ?? vec[];
    $this->supported_licenses = $s['supported_licenses'] ?? vec[];
  }
}
...
class AccountSettings {
  public bool $disable_remote_control;
  public bool $enable_dial_out;

  public function __construct(shape(
    ?'disable_remote_control' => bool,
    ?'enable_dial_out' => bool,
  ) $s = shape()) {
    $this->disable_remote_control = $s['disable_remote_control'] ?? false;
    $this->enable_dial_out = $s['enable_dial_out'] ?? false;
  }
}
...
class AlexaForBusinessMetadata {
  ...
  public bool $is_alexa_for_business_enabled;

  public function __construct(shape(
    ?'alexa_for_business_room_arn' => ?SensitiveString,
    ?'is_alexa_for_business_enabled' => bool,
  ) $s = shape()) {
    $this->alexa_for_business_room_arn = $s['alexa_for_business_room_arn'] ?? '';
    $this->is_alexa_for_business_enabled = $s['is_alexa_for_business_enabled'] ?? false;
  }
}
...
class AssociatePhoneNumberWithUserRequest {
  ...
  public function __construct(shape(
    ...
    $this->account_id = $s['account_id'] ?? '';
    $this->e_164_phone_number = $s['e_164_phone_number'] ?? '';
...
class AssociatePhoneNumbersWithVoiceConnectorGroupRequest {
  ...
  public function __construct(shape(
    ...
    $this->e_164_phone_numbers = $s['e_164_phone_numbers'] ?? vec[];
    $this->force_associate = $s['force_associate'] ?? false;
    $this->voice_connector_group_id = $s['voice_connector_group_id'] ?? '';
  }
}
...
class AssociatePhoneNumbersWithVoiceConnectorGroupResponse {
  ...
  public function __construct(shape(
    ...
    $this->phone_number_errors = $s['phone_number_errors'] ?? vec[];
  }
}
...
class AssociatePhoneNumbersWithVoiceConnectorRequest {
  ...
  public function __construct(shape(
    ...
    $this->e_164_phone_numbers = $s['e_164_phone_numbers'] ?? vec[];
    $this->force_associate = $s['force_associate'] ?? false;
    $this->voice_connector_id = $s['voice_connector_id'] ?? '';
  }
}
...
class Attendee {
  ...
  public function __construct(shape(
    ...
    $this->attendee_id = $s['attendee_id'] ?? '';
    $this->external_user_id = $s['external_user_id'] ?? '';
    $this->join_token = $s['join_token'] ?? '';
  }
}
...
class BatchCreateAttendeeRequest {
  ...
  public function __construct(shape(
    ...
    $this->attendees = $s['attendees'] ?? vec[];
    $this->meeting_id = $s['meeting_id'] ?? '';
  }
}
...
class BatchCreateRoomMembershipRequest {
  ...
  public function __construct(shape(
    ...
    $this->account_id = $s['account_id'] ?? '';
    $this->membership_item_list = $s['membership_item_list'] ?? vec[];
...
class BatchDeletePhoneNumberRequest {
  ...
  public function __construct(shape(
    ...
    $this->phone_number_ids = $s['phone_number_ids'] ?? vec[];
  }
}
...
class BatchSuspendUserRequest {
  ...
  public function __construct(shape(
    ...
    $this->account_id = $s['account_id'] ?? '';
    $this->user_id_list = $s['user_id_list'] ?? vec[];
  }
}
...
class BatchSuspendUserResponse {
  ...
  public function __construct(shape(
    ...
    $this->user_errors = $s['user_errors'] ?? vec[];
  }
}
...
class BatchUpdatePhoneNumberRequest {
  ...
  public function __construct(shape(
    ...
    $this->update_phone_number_request_items = $s['update_phone_number_request_items'] ?? vec[];
  }
}
...
class BatchUpdateUserRequest {
  ...
  public function __construct(shape(
    ...
    $this->account_id = $s['account_id'] ?? '';
    $this->update_user_request_items = $s['update_user_request_items'] ?? vec[];
  }
}
...
class Bot {
  ...
  public function __construct(shape(
    ...
    $this->bot_email = $s['bot_email'] ?? '';
    $this->bot_id = $s['bot_id'] ?? '';
    $this->bot_type = $s['bot_type'] ?? '';
    $this->created_timestamp = $s['created_timestamp'] ?? 0;
    $this->disabled = $s['disabled'] ?? false;
    $this->display_name = $s['display_name'] ?? '';
    $this->security_token = $s['security_token'] ?? '';
    $this->updated_timestamp = $s['updated_timestamp'] ?? 0;
    $this->user_id = $s['user_id'] ?? '';
  }
}
...
class CreateMeetingRequest {
  ...
  public function __construct(shape(
    ...
    $this->external_meeting_id = $s['external_meeting_id'] ?? '';
    $this->media_region = $s['media_region'] ?? '';
    $this->meeting_host_id = $s['meeting_host_id'] ?? '';
    $this->notifications_configuration = $s['notifications_configuration'] ?? null;
    $this->tags = $s['tags'] ?? vec[];
  }
}
...
class CreatePhoneNumberOrderResponse {
  ...
  public function __construct(shape(
    ...
    $this->phone_number_order = $s['phone_number_order'] ?? null;
  }
}
...
class CreateProxySessionRequest {
  ...
  public function __construct(shape(
    ...
    $this->expiry_minutes = $s['expiry_minutes'] ?? 0;
    $this->geo_match_level = $s['geo_match_level'] ?? '';
    $this->geo_match_params = $s['geo_match_params'] ?? null;
    $this->name = $s['name'] ?? '';
    $this->number_selection_behavior = $s['number_selection_behavior'] ?? '';
    $this->participant_phone_numbers = $s['participant_phone_numbers'] ?? vec[];
    $this->voice_connector_id = $s['voice_connector_id'] ?? '';
  }
}
...
class CreateProxySessionResponse {
  ...
  public function __construct(shape(
    ...
    $this->proxy_session = $s['proxy_session'] ?? null;
  }
}
...
class CreateRoomMembershipResponse {
  ...
  public function __construct(shape(
    ...
    $this->room_membership = $s['room_membership'] ?? null;
  }
}
...
class CreateVoiceConnectorGroupRequest {
  ...
  public function __construct(shape(
    ...
    $this->name = $s['name'] ?? '';
    $this->voice_connector_items = $s['voice_connector_items'] ?? vec[];
  }
}
...
class CreateVoiceConnectorGroupResponse {
  ...
  public function __construct(shape(
    ...
    $this->voice_connector_group = $s['voice_connector_group'] ?? null;
  }
}
...
class CreateVoiceConnectorRequest {
  ...
  public bool $require_encryption;
  ...
  public function __construct(shape(
    ...
    $this->name = $s['name'] ?? '';
    $this->require_encryption = $s['require_encryption'] ?? false;
  }
}
...
class CreateVoiceConnectorResponse {
  ...
  public function __construct(shape(
    ...
    $this->voice_connector = $s['voice_connector'] ?? null;
  }
}
...
class DeletePhoneNumberRequest {
  ...
  public function __construct(shape(
    ...
    $this->phone_number_id = $s['phone_number_id'] ?? '';
  }
}
...
class DeleteProxySessionRequest {
  ...
  public function __construct(shape(
    ...
    $this->proxy_session_id = $s['proxy_session_id'] ?? '';
    $this->voice_connector_id = $s['voice_connector_id'] ?? '';
  }
}
...
class DeleteVoiceConnectorTerminationCredentialsRequest {
  ...
  public function __construct(shape(
    ...
    $this->usernames = $s['usernames'] ?? vec[];
    $this->voice_connector_id = $s['voice_connector_id'] ?? '';
  }
}
...
class EventsConfiguration {
  ...
  public function __construct(shape(
    ...
    $this->outbound_events_https_endpoint = $s['outbound_events_https_endpoint'] ?? '';
  }
}
...
class GetEventsConfigurationResponse {
  ...
  public function __construct(shape(
    ...
    $this->events_configuration = $s['events_configuration'] ?? null;
  }
}
...
class GetGlobalSettingsResponse {
  ...
  public function __construct(shape(
    ...
    $this->business_calling = $s['business_calling'] ?? null;
    $this->voice_connector = $s['voice_connector'] ?? null;
  }
}
...
class GetPhoneNumberOrderRequest {
  ...
  public function __construct(shape(
    ...
    $this->phone_number_order_id = $s['phone_number_order_id'] ?? '';
  }
}
...
class GetPhoneNumberResponse {
  ...
  public function __construct(shape(
    ...
    $this->phone_number = $s['phone_number'] ?? null;
  }
}
...
class GetPhoneNumberSettingsResponse {
  ...
  public function __construct(shape(
    ...
    $this->calling_name = $s['calling_name'] ?? '';
    $this->calling_name_updated_timestamp = $s['calling_name_updated_timestamp'] ?? 0;
  }
}
...
class GetVoiceConnectorOriginationResponse {
  ...
  public function __construct(shape(
    ...
    $this->origination = $s['origination'] ?? null;
  }
}
...
class GetVoiceConnectorStreamingConfigurationResponse {
  ...
  public function __construct(shape(
    ...
    $this->streaming_configuration = $s['streaming_configuration'] ?? null;
  }
}
...
class GetVoiceConnectorTerminationHealthResponse {
  ...
  public function __construct(shape(
    ...
    $this->termination_health = $s['termination_health'] ?? null;
  }
}
...
class GetVoiceConnectorTerminationResponse {
  ...
  public function __construct(shape(
    ...
    $this->termination = $s['termination'] ?? null;
  }
}
...
class Invite {
  ...
  public function __construct(shape(
    ...
    $this->email_status = $s['email_status'] ?? '';
    $this->invite_id = $s['invite_id'] ?? '';
...
class InviteUsersRequest {
  ...
  public function __construct(shape(
    ...
    $this->account_id = $s['account_id'] ?? '';
    $this->user_email_list = $s['user_email_list'] ?? vec[];
    $this->user_type = $s['user_type'] ?? '';
  }
}
...
class ListPhoneNumberOrdersResponse {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->phone_number_orders = $s['phone_number_orders'] ?? vec[];
  }
}
...
class ListPhoneNumbersRequest {
  ...
  public function __construct(shape(
    ...
    $this->filter_value = $s['filter_value'] ?? '';
    $this->max_results = $s['max_results'] ?? 0;
    $this->next_token = $s['next_token'] ?? '';
    $this->product_type = $s['product_type'] ?? '';
    $this->status = $s['status'] ?? '';
...
class ListProxySessionsResponse {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->proxy_sessions = $s['proxy_sessions'] ?? vec[];
  }
}
...
class ListRoomMembershipsResponse {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->room_memberships = $s['room_memberships'] ?? vec[];
  }
}
...
class ListVoiceConnectorGroupsResponse {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->voice_connector_groups = $s['voice_connector_groups'] ?? vec[];
  }
}
...
class ListVoiceConnectorsResponse {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->voice_connectors = $s['voice_connectors'] ?? vec[];
  }
}

class LoggingConfiguration {
  public bool $enable_sip_logs;

  public function __construct(shape(
    ?'enable_sip_logs' => bool,
  ) $s = shape()) {
    $this->enable_sip_logs = $s['enable_sip_logs'] ?? false;
  }
}
...
class MediaPlacement {
  ...
  public function __construct(shape(
    ...
    $this->audio_fallback_url = $s['audio_fallback_url'] ?? '';
    $this->audio_host_url = $s['audio_host_url'] ?? '';
    $this->screen_data_url = $s['screen_data_url'] ?? '';
    $this->screen_sharing_url = $s['screen_sharing_url'] ?? '';
    $this->screen_viewing_url = $s['screen_viewing_url'] ?? '';
    $this->signaling_url = $s['signaling_url'] ?? '';
    $this->turn_control_url = $s['turn_control_url'] ?? '';
  }
}
...
class Meeting {
  ...
  public function __construct(shape(
    ...
    $this->external_meeting_id = $s['external_meeting_id'] ?? '';
    $this->media_placement = $s['media_placement'] ?? null;
    $this->media_region = $s['media_region'] ?? '';
    $this->meeting_id = $s['meeting_id'] ?? '';
  }
}
...
class MeetingNotificationConfiguration {
  ...
  public function __construct(shape(
    ...
    $this->sqs_queue_arn = $s['sqs_queue_arn'] ?? '';
  }
}
...
class Participant {
  ...
  public function __construct(shape(
    ...
    $this->proxy_phone_number = $s['proxy_phone_number'] ?? '';
  }
}
...
class PhoneNumber {
  ...
  public function __construct(shape(
    ...
    $this->calling_name = $s['calling_name'] ?? '';
    $this->calling_name_status = $s['calling_name_status'] ?? '';
    $this->capabilities = $s['capabilities'] ?? null;
    $this->created_timestamp = $s['created_timestamp'] ?? 0;
    $this->deletion_timestamp = $s['deletion_timestamp'] ?? 0;
    $this->e_164_phone_number = $s['e_164_phone_number'] ?? '';
    $this->phone_number_id = $s['phone_number_id'] ?? '';
    $this->product_type = $s['product_type'] ?? '';
    $this->status = $s['status'] ?? '';
...
class PhoneNumberAssociation {
  ...
  public function __construct(shape(
    ...
    $this->associated_timestamp = $s['associated_timestamp'] ?? 0;
    $this->name = $s['name'] ?? '';
    $this->value = $s['value'] ?? '';
  }
}
...
class PhoneNumberCapabilities {
  ...
  public function __construct(shape(
    ...
    $this->inbound_call = $s['inbound_call'] ?? false;
    $this->inbound_mms = $s['inbound_mms'] ?? false;
    $this->inbound_sms = $s['inbound_sms'] ?? false;
    $this->outbound_call = $s['outbound_call'] ?? false;
    $this->outbound_mms = $s['outbound_mms'] ?? false;
    $this->outbound_sms = $s['outbound_sms'] ?? false;
  }
}
...
class PhoneNumberOrder {
  ...
  public function __construct(shape(
    ...
    $this->created_timestamp = $s['created_timestamp'] ?? 0;
    $this->ordered_phone_numbers = $s['ordered_phone_numbers'] ?? vec[];
    $this->phone_number_order_id = $s['phone_number_order_id'] ?? '';
    $this->product_type = $s['product_type'] ?? '';
    $this->status = $s['status'] ?? '';
    $this->updated_timestamp = $s['updated_timestamp'] ?? 0;
...
class Proxy {
  ...
  public function __construct(shape(
    ...
    $this->default_session_expiry_minutes = $s['default_session_expiry_minutes'] ?? 0;
    $this->disabled = $s['disabled'] ?? false;
    $this->fall_back_phone_number = $s['fall_back_phone_number'] ?? '';
    $this->phone_number_countries = $s['phone_number_countries'] ?? vec[];
  }
}
...
class ProxySession {
  ...
  public function __construct(shape(
    ...
    $this->capabilities = $s['capabilities'] ?? vec[];
    $this->created_timestamp = $s['created_timestamp'] ?? 0;
    $this->ended_timestamp = $s['ended_timestamp'] ?? 0;
    $this->expiry_minutes = $s['expiry_minutes'] ?? 0;
    $this->geo_match_level = $s['geo_match_level'] ?? '';
    $this->geo_match_params = $s['geo_match_params'] ?? null;
    $this->name = $s['name'] ?? '';
    $this->number_selection_behavior = $s['number_selection_behavior'] ?? '';
    $this->participants = $s['participants'] ?? vec[];
    $this->proxy_session_id = $s['proxy_session_id'] ?? '';
    $this->status = $s['status'] ?? '';
    $this->updated_timestamp = $s['updated_timestamp'] ?? 0;
    $this->voice_connector_id = $s['voice_connector_id'] ?? '';
...
class PutVoiceConnectorProxyRequest {
  ...
  public function __construct(shape(
    ...
    $this->disabled = $s['disabled'] ?? false;
    $this->fall_back_phone_number = $s['fall_back_phone_number'] ?? '';
    $this->phone_number_pool_countries = $s['phone_number_pool_countries'] ?? vec[];
    $this->voice_connector_id = $s['voice_connector_id'] ?? '';
  }
}
...
class PutVoiceConnectorTerminationCredentialsRequest {
  ...
  public function __construct(shape(
    ...
    $this->credentials = $s['credentials'] ?? vec[];
    $this->voice_connector_id = $s['voice_connector_id'] ?? '';
  }
}
...
class SearchAvailablePhoneNumbersRequest {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->state = $s['state'] ?? '';
    $this->toll_free_prefix = $s['toll_free_prefix'] ?? '';
  }
}
...
class TelephonySettings {
  public bool $inbound_calling;
  public bool $outbound_calling;
  public bool $sms;
  ...
  public function __construct(shape(
    ...
    $this->inbound_calling = $s['inbound_calling'] ?? false;
    $this->outbound_calling = $s['outbound_calling'] ?? false;
    $this->sms = $s['sms'] ?? false;
  }
}
...
class Termination {
  ...
  public function __construct(shape(
    ...
    $this->calling_regions = $s['calling_regions'] ?? vec[];
    $this->cidr_allowed_list = $s['cidr_allowed_list'] ?? vec[];
    $this->cps_limit = $s['cps_limit'] ?? 0;
    $this->default_phone_number = $s['default_phone_number'] ?? '';
    $this->disabled = $s['disabled'] ?? false;
  }
}
...
class UpdateUserRequest {
  ...
  public function __construct(shape(
    ...
    $this->account_id = $s['account_id'] ?? '';
    $this->alexa_for_business_metadata = $s['alexa_for_business_metadata'] ?? null;
...
class User {
  ...
  public function __construct(shape(
    ...
    $this->alexa_for_business_metadata = $s['alexa_for_business_metadata'] ?? null;
    $this->display_name = $s['display_name'] ?? '';
    $this->invited_on = $s['invited_on'] ?? 0;
    $this->license_type = $s['license_type'] ?? '';
    $this->personal_pin = $s['personal_pin'] ?? '';
    $this->primary_email = $s['primary_email'] ?? '';
    $this->primary_provisioned_number = $s['primary_provisioned_number'] ?? '';
    $this->registered_on = $s['registered_on'] ?? 0;
    $this->user_id = $s['user_id'] ?? '';
    $this->user_invitation_status = $s['user_invitation_status'] ?? '';
    $this->user_registration_status = $s['user_registration_status'] ?? '';
    $this->user_type = $s['user_type'] ?? '';
  }
}
...
class UserSettings {
  ...
  public function __construct(shape(
    ...
    $this->telephony = $s['telephony'] ?? null;
  }
}
...
class VoiceConnector {
  ...
  public function __construct(shape(
    ...
    $this->created_timestamp = $s['created_timestamp'] ?? 0;
    $this->name = $s['name'] ?? '';
    $this->outbound_host_name = $s['outbound_host_name'] ?? '';
    $this->require_encryption = $s['require_encryption'] ?? false;
    $this->updated_timestamp = $s['updated_timestamp'] ?? 0;
    $this->voice_connector_id = $s['voice_connector_id'] ?? '';
  }
