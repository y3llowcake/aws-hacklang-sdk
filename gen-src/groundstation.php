...
interface GroundStation {
  public function CancelContact(CancelContactRequest $in): Awaitable<\Errors\Result<ContactIdResponse>>;
  public function CreateConfig(CreateConfigRequest $in): Awaitable<\Errors\Result<ConfigIdResponse>>;
  public function CreateDataflowEndpointGroup(CreateDataflowEndpointGroupRequest $in): Awaitable<\Errors\Result<DataflowEndpointGroupIdResponse>>;
  public function CreateMissionProfile(CreateMissionProfileRequest $in): Awaitable<\Errors\Result<MissionProfileIdResponse>>;
  public function DeleteConfig(DeleteConfigRequest $in): Awaitable<\Errors\Result<ConfigIdResponse>>;
  public function DeleteDataflowEndpointGroup(DeleteDataflowEndpointGroupRequest $in): Awaitable<\Errors\Result<DataflowEndpointGroupIdResponse>>;
  public function DeleteMissionProfile(DeleteMissionProfileRequest $in): Awaitable<\Errors\Result<MissionProfileIdResponse>>;
  public function DescribeContact(DescribeContactRequest $in): Awaitable<\Errors\Result<DescribeContactResponse>>;
  public function GetConfig(GetConfigRequest $in): Awaitable<\Errors\Result<GetConfigResponse>>;
  public function GetDataflowEndpointGroup(GetDataflowEndpointGroupRequest $in): Awaitable<\Errors\Result<GetDataflowEndpointGroupResponse>>;
  public function GetMinuteUsage(GetMinuteUsageRequest $in): Awaitable<\Errors\Result<GetMinuteUsageResponse>>;
  public function GetMissionProfile(GetMissionProfileRequest $in): Awaitable<\Errors\Result<GetMissionProfileResponse>>;
  public function GetSatellite(GetSatelliteRequest $in): Awaitable<\Errors\Result<GetSatelliteResponse>>;
  public function ListConfigs(ListConfigsRequest $in): Awaitable<\Errors\Result<ListConfigsResponse>>;
  public function ListContacts(ListContactsRequest $in): Awaitable<\Errors\Result<ListContactsResponse>>;
  public function ListDataflowEndpointGroups(ListDataflowEndpointGroupsRequest $in): Awaitable<\Errors\Result<ListDataflowEndpointGroupsResponse>>;
  public function ListGroundStations(ListGroundStationsRequest $in): Awaitable<\Errors\Result<ListGroundStationsResponse>>;
  public function ListMissionProfiles(ListMissionProfilesRequest $in): Awaitable<\Errors\Result<ListMissionProfilesResponse>>;
  public function ListSatellites(ListSatellitesRequest $in): Awaitable<\Errors\Result<ListSatellitesResponse>>;
  public function ListTagsForResource(ListTagsForResourceRequest $in): Awaitable<\Errors\Result<ListTagsForResourceResponse>>;
  public function ReserveContact(ReserveContactRequest $in): Awaitable<\Errors\Result<ContactIdResponse>>;
  ...
  public function UpdateConfig(UpdateConfigRequest $in): Awaitable<\Errors\Result<ConfigIdResponse>>;
  public function UpdateMissionProfile(UpdateMissionProfileRequest $in): Awaitable<\Errors\Result<MissionProfileIdResponse>>;
}
...
class AntennaDownlinkConfig {
  ...
  public function __construct(shape(
    ...
    $this->spectrum_config = $s['spectrum_config'] ?? null;
  }
}
...
class AntennaDownlinkDemodDecodeConfig {
  ...
  public function __construct(shape(
    ...
    $this->decode_config = $s['decode_config'] ?? null;
    $this->demodulation_config = $s['demodulation_config'] ?? null;
    $this->spectrum_config = $s['spectrum_config'] ?? null;
  }
}
...
class AntennaUplinkConfig {
  ...
  public function __construct(shape(
    ...
    $this->spectrum_config = $s['spectrum_config'] ?? null;
    $this->target_eirp = $s['target_eirp'] ?? null;
  }
}
...
class ConfigIdResponse {
  ...
  public function __construct(shape(
    ...
    $this->config_arn = $s['config_arn'] ?? '';
    $this->config_id = $s['config_id'] ?? '';
...
class ConfigTypeData {
  ...
  public function __construct(shape(
    ...
    $this->antenna_downlink_config = $s['antenna_downlink_config'] ?? null;
    $this->antenna_downlink_demod_decode_config = $s['antenna_downlink_demod_decode_config'] ?? null;
    $this->antenna_uplink_config = $s['antenna_uplink_config'] ?? null;
    $this->dataflow_endpoint_config = $s['dataflow_endpoint_config'] ?? null;
    $this->tracking_config = $s['tracking_config'] ?? null;
    $this->uplink_echo_config = $s['uplink_echo_config'] ?? null;
  }
}
...
class ContactData {
  ...
  public function __construct(shape(
    ...
    $this->contact_id = $s['contact_id'] ?? '';
    $this->contact_status = $s['contact_status'] ?? '';
    $this->end_time = $s['end_time'] ?? 0;
    $this->error_message = $s['error_message'] ?? '';
    $this->ground_station = $s['ground_station'] ?? '';
    $this->maximum_elevation = $s['maximum_elevation'] ?? null;
    $this->mission_profile_arn = $s['mission_profile_arn'] ?? '';
    $this->post_pass_end_time = $s['post_pass_end_time'] ?? 0;
    $this->pre_pass_start_time = $s['pre_pass_start_time'] ?? 0;
    $this->region = $s['region'] ?? '';
    $this->satellite_arn = $s['satellite_arn'] ?? '';
...
class CreateConfigRequest {
  ...
  public function __construct(shape(
    ...
    $this->config_data = $s['config_data'] ?? null;
    $this->name = $s['name'] ?? '';
    $this->tags = $s['tags'] ?? dict[];
  }
}
...
class CreateDataflowEndpointGroupRequest {
  ...
  public function __construct(shape(
    ...
    $this->endpoint_details = $s['endpoint_details'] ?? vec[];
    $this->tags = $s['tags'] ?? dict[];
  }
}
...
class CreateMissionProfileRequest {
  ...
  public function __construct(shape(
    ...
    $this->contact_post_pass_duration_seconds = $s['contact_post_pass_duration_seconds'] ?? 0;
    $this->contact_pre_pass_duration_seconds = $s['contact_pre_pass_duration_seconds'] ?? 0;
    $this->dataflow_edges = $s['dataflow_edges'] ?? vec[];
    $this->minimum_viable_contact_duration_seconds = $s['minimum_viable_contact_duration_seconds'] ?? 0;
    $this->name = $s['name'] ?? '';
    $this->tags = $s['tags'] ?? dict[];
    $this->tracking_config_arn = $s['tracking_config_arn'] ?? '';
  }
}
...
class DataflowEndpointConfig {
  ...
  public function __construct(shape(
    ...
    $this->dataflow_endpoint_name = $s['dataflow_endpoint_name'] ?? '';
    $this->dataflow_endpoint_region = $s['dataflow_endpoint_region'] ?? '';
  }
}
...
class DataflowEndpointGroupIdResponse {
  ...
  public function __construct(shape(
    ...
    $this->dataflow_endpoint_group_id = $s['dataflow_endpoint_group_id'] ?? '';
  }
}
...
class DataflowEndpointListItem {
  ...
  public function __construct(shape(
    ...
    $this->dataflow_endpoint_group_arn = $s['dataflow_endpoint_group_arn'] ?? '';
    $this->dataflow_endpoint_group_id = $s['dataflow_endpoint_group_id'] ?? '';
  }
}
...
class DecodeConfig {
  ...
  public function __construct(shape(
    ...
    $this->unvalidated_json = $s['unvalidated_json'] ?? '';
  }
}
...
class DeleteMissionProfileRequest {
  ...
  public function __construct(shape(
    ...
    $this->mission_profile_id = $s['mission_profile_id'] ?? '';
  }
}
...
class EndpointDetails {
  ...
  public function __construct(shape(
    ...
    $this->security_details = $s['security_details'] ?? null;
  }
}
...
class GetDataflowEndpointGroupResponse {
  ...
  public function __construct(shape(
    ...
    $this->dataflow_endpoint_group_arn = $s['dataflow_endpoint_group_arn'] ?? '';
    $this->dataflow_endpoint_group_id = $s['dataflow_endpoint_group_id'] ?? '';
    $this->endpoints_details = $s['endpoints_details'] ?? vec[];
    $this->tags = $s['tags'] ?? dict[];
  }
}
...
class GetMinuteUsageResponse {
  ...
  public bool $is_reserved_minutes_customer;
  ...
  public function __construct(shape(
    ...
    $this->estimated_minutes_remaining = $s['estimated_minutes_remaining'] ?? 0;
    $this->is_reserved_minutes_customer = $s['is_reserved_minutes_customer'] ?? false;
    $this->total_reserved_minute_allocation = $s['total_reserved_minute_allocation'] ?? 0;
    $this->total_scheduled_minutes = $s['total_scheduled_minutes'] ?? 0;
    $this->upcoming_minutes_scheduled = $s['upcoming_minutes_scheduled'] ?? 0;
  }
}
...
class GetSatelliteRequest {
  ...
  public function __construct(shape(
    ...
    $this->satellite_id = $s['satellite_id'] ?? '';
  }
}
...
class GetSatelliteResponse {
  ...
  public function __construct(shape(
    ...
    $this->ground_stations = $s['ground_stations'] ?? vec[];
    $this->norad_satellite_id = $s['norad_satellite_id'] ?? 0;
    $this->satellite_arn = $s['satellite_arn'] ?? '';
    $this->satellite_id = $s['satellite_id'] ?? '';
  }
}
...
class GroundStationData {
  ...
  public function __construct(shape(
    ...
    $this->ground_station_id = $s['ground_station_id'] ?? '';
    $this->ground_station_name = $s['ground_station_name'] ?? '';
    $this->region = $s['region'] ?? '';
  }
}
...
class ListConfigsResponse {
  ...
  public function __construct(shape(
    ...
    $this->config_list = $s['config_list'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListContactsResponse {
  ...
  public function __construct(shape(
    ...
    $this->contact_list = $s['contact_list'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListDataflowEndpointGroupsResponse {
  ...
  public function __construct(shape(
    ...
    $this->dataflow_endpoint_group_list = $s['dataflow_endpoint_group_list'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListGroundStationsResponse {
  ...
  public function __construct(shape(
    ...
    $this->ground_station_list = $s['ground_station_list'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListMissionProfilesResponse {
  ...
  public function __construct(shape(
    ...
    $this->mission_profile_list = $s['mission_profile_list'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListSatellitesResponse {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->satellites = $s['satellites'] ?? vec[];
  }
}
...
class SpectrumConfig {
  ...
  public function __construct(shape(
    ...
    $this->center_frequency = $s['center_frequency'] ?? null;
    $this->polarization = $s['polarization'] ?? '';
  }
}
...
class UplinkEchoConfig {
  ...
  public function __construct(shape(
    ...
    $this->antenna_uplink_config_arn = $s['antenna_uplink_config_arn'] ?? '';
