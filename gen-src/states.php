...
interface SFN {
  public function CreateActivity(CreateActivityInput $in): Awaitable<\Errors\Result<CreateActivityOutput>>;
  public function CreateStateMachine(CreateStateMachineInput $in): Awaitable<\Errors\Result<CreateStateMachineOutput>>;
  public function DeleteActivity(DeleteActivityInput $in): Awaitable<\Errors\Result<DeleteActivityOutput>>;
  public function DeleteStateMachine(DeleteStateMachineInput $in): Awaitable<\Errors\Result<DeleteStateMachineOutput>>;
  public function DescribeActivity(DescribeActivityInput $in): Awaitable<\Errors\Result<DescribeActivityOutput>>;
  public function DescribeExecution(DescribeExecutionInput $in): Awaitable<\Errors\Result<DescribeExecutionOutput>>;
  public function DescribeStateMachine(DescribeStateMachineInput $in): Awaitable<\Errors\Result<DescribeStateMachineOutput>>;
  public function DescribeStateMachineForExecution(DescribeStateMachineForExecutionInput $in): Awaitable<\Errors\Result<DescribeStateMachineForExecutionOutput>>;
  public function GetActivityTask(GetActivityTaskInput $in): Awaitable<\Errors\Result<GetActivityTaskOutput>>;
  public function GetExecutionHistory(GetExecutionHistoryInput $in): Awaitable<\Errors\Result<GetExecutionHistoryOutput>>;
  public function ListActivities(ListActivitiesInput $in): Awaitable<\Errors\Result<ListActivitiesOutput>>;
  public function ListExecutions(ListExecutionsInput $in): Awaitable<\Errors\Result<ListExecutionsOutput>>;
  public function ListStateMachines(ListStateMachinesInput $in): Awaitable<\Errors\Result<ListStateMachinesOutput>>;
  public function ListTagsForResource(ListTagsForResourceInput $in): Awaitable<\Errors\Result<ListTagsForResourceOutput>>;
  public function SendTaskFailure(SendTaskFailureInput $in): Awaitable<\Errors\Result<SendTaskFailureOutput>>;
  public function SendTaskHeartbeat(SendTaskHeartbeatInput $in): Awaitable<\Errors\Result<SendTaskHeartbeatOutput>>;
  public function SendTaskSuccess(SendTaskSuccessInput $in): Awaitable<\Errors\Result<SendTaskSuccessOutput>>;
  public function StartExecution(StartExecutionInput $in): Awaitable<\Errors\Result<StartExecutionOutput>>;
  public function StopExecution(StopExecutionInput $in): Awaitable<\Errors\Result<StopExecutionOutput>>;
  ...
  public function UpdateStateMachine(UpdateStateMachineInput $in): Awaitable<\Errors\Result<UpdateStateMachineOutput>>;
}
...
class ActivityListItem {
  ...
  public function __construct(shape(
    ...
    $this->activity_arn = $s['activity_arn'] ?? '';
...
class ActivityScheduledEventDetails {
  ...
  public function __construct(shape(
    ...
    $this->heartbeat_in_seconds = $s['heartbeat_in_seconds'] ?? 0;
    $this->input = $s['input'] ?? '';
...
class ActivityStartedEventDetails {
  ...
  public function __construct(shape(
    ...
    $this->worker_name = $s['worker_name'] ?? '';
  }
}
...
class CreateStateMachineOutput {
  ...
  public function __construct(shape(
    ...
    $this->creation_date = $s['creation_date'] ?? 0;
    $this->state_machine_arn = $s['state_machine_arn'] ?? '';
  }
}
...
class DescribeExecutionInput {
  ...
  public function __construct(shape(
    ...
    $this->execution_arn = $s['execution_arn'] ?? '';
  }
}
...
class HistoryEvent {
  ...
  public function __construct(shape(
    ...
    $this->activity_failed_event_details = $s['activity_failed_event_details'] ?? null;
    $this->activity_schedule_failed_event_details = $s['activity_schedule_failed_event_details'] ?? null;
    $this->activity_scheduled_event_details = $s['activity_scheduled_event_details'] ?? null;
    $this->activity_started_event_details = $s['activity_started_event_details'] ?? null;
    $this->activity_succeeded_event_details = $s['activity_succeeded_event_details'] ?? null;
    $this->activity_timed_out_event_details = $s['activity_timed_out_event_details'] ?? null;
    $this->execution_aborted_event_details = $s['execution_aborted_event_details'] ?? null;
    $this->execution_failed_event_details = $s['execution_failed_event_details'] ?? null;
    $this->execution_started_event_details = $s['execution_started_event_details'] ?? null;
    $this->execution_succeeded_event_details = $s['execution_succeeded_event_details'] ?? null;
    $this->execution_timed_out_event_details = $s['execution_timed_out_event_details'] ?? null;
    $this->id = $s['id'] ?? 0;
    $this->lambda_function_failed_event_details = $s['lambda_function_failed_event_details'] ?? null;
    $this->lambda_function_schedule_failed_event_details = $s['lambda_function_schedule_failed_event_details'] ?? null;
    $this->lambda_function_scheduled_event_details = $s['lambda_function_scheduled_event_details'] ?? null;
    $this->lambda_function_start_failed_event_details = $s['lambda_function_start_failed_event_details'] ?? null;
    $this->lambda_function_succeeded_event_details = $s['lambda_function_succeeded_event_details'] ?? null;
    $this->lambda_function_timed_out_event_details = $s['lambda_function_timed_out_event_details'] ?? null;
    $this->map_iteration_aborted_event_details = $s['map_iteration_aborted_event_details'] ?? null;
    $this->map_iteration_failed_event_details = $s['map_iteration_failed_event_details'] ?? null;
    $this->map_iteration_started_event_details = $s['map_iteration_started_event_details'] ?? null;
    $this->map_iteration_succeeded_event_details = $s['map_iteration_succeeded_event_details'] ?? null;
    $this->map_state_started_event_details = $s['map_state_started_event_details'] ?? null;
    $this->previous_event_id = $s['previous_event_id'] ?? 0;
    $this->state_entered_event_details = $s['state_entered_event_details'] ?? null;
    $this->state_exited_event_details = $s['state_exited_event_details'] ?? null;
    $this->task_failed_event_details = $s['task_failed_event_details'] ?? null;
    $this->task_scheduled_event_details = $s['task_scheduled_event_details'] ?? null;
    $this->task_start_failed_event_details = $s['task_start_failed_event_details'] ?? null;
    $this->task_started_event_details = $s['task_started_event_details'] ?? null;
    $this->task_submit_failed_event_details = $s['task_submit_failed_event_details'] ?? null;
    $this->task_submitted_event_details = $s['task_submitted_event_details'] ?? null;
    $this->task_succeeded_event_details = $s['task_succeeded_event_details'] ?? null;
    $this->task_timed_out_event_details = $s['task_timed_out_event_details'] ?? null;
...
class ListExecutionsOutput {
  ...
  public function __construct(shape(
    ...
    $this->executions = $s['executions'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListStateMachinesOutput {
  ...
  public function __construct(shape(
    ...
    $this->next_token = $s['next_token'] ?? '';
    $this->state_machines = $s['state_machines'] ?? vec[];
  }
}
...
class LogDestination {
  ...
  public function __construct(shape(
    ...
    $this->cloud_watch_logs_log_group = $s['cloud_watch_logs_log_group'] ?? null;
  }
}
...
class LoggingConfiguration {
  ...
  public function __construct(shape(
    ...
    $this->include_execution_data = $s['include_execution_data'] ?? false;
    $this->level = $s['level'] ?? '';
  }
}
