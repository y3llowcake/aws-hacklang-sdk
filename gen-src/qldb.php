...
interface QLDB {
  public function CreateLedger(CreateLedgerRequest $in): Awaitable<\Errors\Result<CreateLedgerResponse>>;
  public function DeleteLedger(DeleteLedgerRequest $in): Awaitable<\Errors\Error>;
  public function DescribeJournalS3Export(DescribeJournalS3ExportRequest $in): Awaitable<\Errors\Result<DescribeJournalS3ExportResponse>>;
  public function DescribeLedger(DescribeLedgerRequest $in): Awaitable<\Errors\Result<DescribeLedgerResponse>>;
  public function ExportJournalToS3(ExportJournalToS3Request $in): Awaitable<\Errors\Result<ExportJournalToS3Response>>;
  public function GetBlock(GetBlockRequest $in): Awaitable<\Errors\Result<GetBlockResponse>>;
  public function GetDigest(GetDigestRequest $in): Awaitable<\Errors\Result<GetDigestResponse>>;
  public function GetRevision(GetRevisionRequest $in): Awaitable<\Errors\Result<GetRevisionResponse>>;
  public function ListJournalS3Exports(ListJournalS3ExportsRequest $in): Awaitable<\Errors\Result<ListJournalS3ExportsResponse>>;
  public function ListJournalS3ExportsForLedger(ListJournalS3ExportsForLedgerRequest $in): Awaitable<\Errors\Result<ListJournalS3ExportsForLedgerResponse>>;
  public function ListLedgers(ListLedgersRequest $in): Awaitable<\Errors\Result<ListLedgersResponse>>;
  ...
  public function UpdateLedger(UpdateLedgerRequest $in): Awaitable<\Errors\Result<UpdateLedgerResponse>>;
}
...
class CreateLedgerRequest {
  ...
  public function __construct(shape(
    ...
    $this->name = $s['name'] ?? '';
    $this->permissions_mode = $s['permissions_mode'] ?? '';
...
class DescribeJournalS3ExportResponse {
  ...
  public function __construct(shape(
    ...
    $this->export_description = $s['export_description'] ?? null;
  }
}
...
class ExportJournalToS3Request {
  ...
  public function __construct(shape(
    ...
    $this->exclusive_end_time = $s['exclusive_end_time'] ?? 0;
    $this->inclusive_start_time = $s['inclusive_start_time'] ?? 0;
    $this->name = $s['name'] ?? '';
    $this->role_arn = $s['role_arn'] ?? '';
    $this->s_3_export_configuration = $s['s_3_export_configuration'] ?? null;
  }
}
...
class GetBlockRequest {
  ...
  public function __construct(shape(
    ...
    $this->block_address = $s['block_address'] ?? null;
    $this->digest_tip_address = $s['digest_tip_address'] ?? null;
    $this->name = $s['name'] ?? '';
  }
}
...
class JournalS3ExportDescription {
  ...
  public function __construct(shape(
    ...
    $this->exclusive_end_time = $s['exclusive_end_time'] ?? 0;
    $this->export_creation_time = $s['export_creation_time'] ?? 0;
    $this->export_id = $s['export_id'] ?? '';
    $this->inclusive_start_time = $s['inclusive_start_time'] ?? 0;
    $this->ledger_name = $s['ledger_name'] ?? '';
    $this->role_arn = $s['role_arn'] ?? '';
    $this->s_3_export_configuration = $s['s_3_export_configuration'] ?? null;
...
class ListJournalS3ExportsForLedgerResponse {
  ...
  public function __construct(shape(
    ...
    $this->journal_s_3_exports = $s['journal_s_3_exports'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class S3EncryptionConfiguration {
  ...
  public function __construct(shape(
    ...
    $this->object_encryption_type = $s['object_encryption_type'] ?? '';
  }
}
