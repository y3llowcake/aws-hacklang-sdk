...
interface MediaLive {
  public function BatchUpdateSchedule(BatchUpdateScheduleRequest $in): Awaitable<\Errors\Result<BatchUpdateScheduleResponse>>;
  ...
  public function CreateInputSecurityGroup(CreateInputSecurityGroupRequest $in): Awaitable<\Errors\Result<CreateInputSecurityGroupResponse>>;
  public function CreateMultiplex(CreateMultiplexRequest $in): Awaitable<\Errors\Result<CreateMultiplexResponse>>;
  public function CreateMultiplexProgram(CreateMultiplexProgramRequest $in): Awaitable<\Errors\Result<CreateMultiplexProgramResponse>>;
  ...
  public function DeleteInputSecurityGroup(DeleteInputSecurityGroupRequest $in): Awaitable<\Errors\Result<DeleteInputSecurityGroupResponse>>;
  public function DeleteMultiplex(DeleteMultiplexRequest $in): Awaitable<\Errors\Result<DeleteMultiplexResponse>>;
  public function DeleteMultiplexProgram(DeleteMultiplexProgramRequest $in): Awaitable<\Errors\Result<DeleteMultiplexProgramResponse>>;
  public function DeleteReservation(DeleteReservationRequest $in): Awaitable<\Errors\Result<DeleteReservationResponse>>;
  public function DeleteSchedule(DeleteScheduleRequest $in): Awaitable<\Errors\Result<DeleteScheduleResponse>>;
  ...
  public function DescribeInputSecurityGroup(DescribeInputSecurityGroupRequest $in): Awaitable<\Errors\Result<DescribeInputSecurityGroupResponse>>;
  public function DescribeMultiplex(DescribeMultiplexRequest $in): Awaitable<\Errors\Result<DescribeMultiplexResponse>>;
  public function DescribeMultiplexProgram(DescribeMultiplexProgramRequest $in): Awaitable<\Errors\Result<DescribeMultiplexProgramResponse>>;
  public function DescribeOffering(DescribeOfferingRequest $in): Awaitable<\Errors\Result<DescribeOfferingResponse>>;
  public function DescribeReservation(DescribeReservationRequest $in): Awaitable<\Errors\Result<DescribeReservationResponse>>;
  public function DescribeSchedule(DescribeScheduleRequest $in): Awaitable<\Errors\Result<DescribeScheduleResponse>>;
  public function ListChannels(ListChannelsRequest $in): Awaitable<\Errors\Result<ListChannelsResponse>>;
  public function ListInputSecurityGroups(ListInputSecurityGroupsRequest $in): Awaitable<\Errors\Result<ListInputSecurityGroupsResponse>>;
  public function ListInputs(ListInputsRequest $in): Awaitable<\Errors\Result<ListInputsResponse>>;
  public function ListMultiplexPrograms(ListMultiplexProgramsRequest $in): Awaitable<\Errors\Result<ListMultiplexProgramsResponse>>;
  public function ListMultiplexes(ListMultiplexesRequest $in): Awaitable<\Errors\Result<ListMultiplexesResponse>>;
  public function ListOfferings(ListOfferingsRequest $in): Awaitable<\Errors\Result<ListOfferingsResponse>>;
  public function ListReservations(ListReservationsRequest $in): Awaitable<\Errors\Result<ListReservationsResponse>>;
  public function ListTagsForResource(ListTagsForResourceRequest $in): Awaitable<\Errors\Result<ListTagsForResourceResponse>>;
  public function PurchaseOffering(PurchaseOfferingRequest $in): Awaitable<\Errors\Result<PurchaseOfferingResponse>>;
  public function StartChannel(StartChannelRequest $in): Awaitable<\Errors\Result<StartChannelResponse>>;
  public function StartMultiplex(StartMultiplexRequest $in): Awaitable<\Errors\Result<StartMultiplexResponse>>;
  public function StopChannel(StopChannelRequest $in): Awaitable<\Errors\Result<StopChannelResponse>>;
  public function StopMultiplex(StopMultiplexRequest $in): Awaitable<\Errors\Result<StopMultiplexResponse>>;
  public function UpdateChannel(UpdateChannelRequest $in): Awaitable<\Errors\Result<UpdateChannelResponse>>;
  public function UpdateChannelClass(UpdateChannelClassRequest $in): Awaitable<\Errors\Result<UpdateChannelClassResponse>>;
  public function UpdateInput(UpdateInputRequest $in): Awaitable<\Errors\Result<UpdateInputResponse>>;
  public function UpdateInputSecurityGroup(UpdateInputSecurityGroupRequest $in): Awaitable<\Errors\Result<UpdateInputSecurityGroupResponse>>;
  public function UpdateMultiplex(UpdateMultiplexRequest $in): Awaitable<\Errors\Result<UpdateMultiplexResponse>>;
  public function UpdateMultiplexProgram(UpdateMultiplexProgramRequest $in): Awaitable<\Errors\Result<UpdateMultiplexProgramResponse>>;
  public function UpdateReservation(UpdateReservationRequest $in): Awaitable<\Errors\Result<UpdateReservationResponse>>;
}
...
class AacSettings {
  ...
  public function __construct(shape(
    ...
    $this->sample_rate = $s['sample_rate'] ?? 0.0;
    $this->spec = $s['spec'] ?? '';
...
class Ac3Settings {
  ...
  public function __construct(shape(
    ...
    $this->drc_profile = $s['drc_profile'] ?? '';
...
class ArchiveGroupSettings {
  ...
  public function __construct(shape(
    ...
    $this->rollover_interval = $s['rollover_interval'] ?? 0;
  }
}
...
class AudioChannelMapping {
  ...
  public function __construct(shape(
    ...
    $this->input_channel_levels = $s['input_channel_levels'] ?? vec[];
    $this->output_channel = $s['output_channel'] ?? 0;
  }
}
...
class AudioCodecSettings {
  ...
  public function __construct(shape(
    ...
    $this->pass_through_settings = $s['pass_through_settings'] ?? null;
  }
}
...
class AudioDescription {
  ...
  public function __construct(shape(
    ...
    $this->audio_selector_name = $s['audio_selector_name'] ?? '';
    $this->audio_type = $s['audio_type'] ?? '';
...
class AudioLanguageSelection {
  ...
  public function __construct(shape(
    ...
    $this->language_code = $s['language_code'] ?? '';
    $this->language_selection_policy = $s['language_selection_policy'] ?? '';
  }
}
...
class AudioOnlyHlsSettings {
  ...
  public function __construct(shape(
    ...
    $this->audio_only_image = $s['audio_only_image'] ?? null;
...
class AudioSelector {
  ...
  public function __construct(shape(
    ...
    $this->name = $s['name'] ?? '';
    $this->selector_settings = $s['selector_settings'] ?? null;
  }
}
...
class AudioSelectorSettings {
  ...
  public function __construct(shape(
    ...
    $this->audio_language_selection = $s['audio_language_selection'] ?? null;
    $this->audio_pid_selection = $s['audio_pid_selection'] ?? null;
  }
}
...
class AutomaticInputFailoverSettings {
  ...
  public function __construct(shape(
    ...
    $this->input_preference = $s['input_preference'] ?? '';
    $this->secondary_input_id = $s['secondary_input_id'] ?? '';
  }
}
...
class AvailBlanking {
  ...
  public function __construct(shape(
    ...
    $this->avail_blanking_image = $s['avail_blanking_image'] ?? null;
    $this->state = $s['state'] ?? '';
  }
}
...
class AvailConfiguration {
  ...
  public function __construct(shape(
    ...
    $this->avail_settings = $s['avail_settings'] ?? null;
  }
}
...
class AvailSettings {
  ...
  public function __construct(shape(
    ...
    $this->scte_35_splice_insert = $s['scte_35_splice_insert'] ?? null;
    $this->scte_35_time_signal_apos = $s['scte_35_time_signal_apos'] ?? null;
  }
}
...
class BatchScheduleActionCreateRequest {
  ...
  public function __construct(shape(
    ...
    $this->schedule_actions = $s['schedule_actions'] ?? vec[];
  }
}
...
class BatchUpdateScheduleRequest {
  ...
  public function __construct(shape(
    ...
    $this->creates = $s['creates'] ?? null;
    $this->deletes = $s['deletes'] ?? null;
  }
}
...
class BlackoutSlate {
  ...
  public function __construct(shape(
    ...
    $this->blackout_slate_image = $s['blackout_slate_image'] ?? null;
    $this->network_end_blackout = $s['network_end_blackout'] ?? '';
    $this->network_end_blackout_image = $s['network_end_blackout_image'] ?? null;
...
class BurnInDestinationSettings {
  ...
  public function __construct(shape(
    ...
    $this->teletext_grid_control = $s['teletext_grid_control'] ?? '';
...
class CaptionDestinationSettings {
  ...
  public function __construct(shape(
    ...
    $this->arib_destination_settings = $s['arib_destination_settings'] ?? null;
    $this->burn_in_destination_settings = $s['burn_in_destination_settings'] ?? null;
    ...
    $this->embedded_plus_scte_20_destination_settings = $s['embedded_plus_scte_20_destination_settings'] ?? null;
    $this->rtmp_caption_info_destination_settings = $s['rtmp_caption_info_destination_settings'] ?? null;
    $this->scte_20_plus_embedded_destination_settings = $s['scte_20_plus_embedded_destination_settings'] ?? null;
    $this->scte_27_destination_settings = $s['scte_27_destination_settings'] ?? null;
    $this->smpte_tt_destination_settings = $s['smpte_tt_destination_settings'] ?? null;
    ...
    $this->webvtt_destination_settings = $s['webvtt_destination_settings'] ?? null;
  }
}
...
class CaptionSelectorSettings {
  ...
  public function __construct(shape(
    ...
    $this->arib_source_settings = $s['arib_source_settings'] ?? null;
    $this->dvb_sub_source_settings = $s['dvb_sub_source_settings'] ?? null;
    $this->embedded_source_settings = $s['embedded_source_settings'] ?? null;
    $this->scte_20_source_settings = $s['scte_20_source_settings'] ?? null;
    $this->scte_27_source_settings = $s['scte_27_source_settings'] ?? null;
...
class Channel {
  ...
  public function __construct(shape(
    ...
    $this->arn = $s['arn'] ?? '';
    $this->channel_class = $s['channel_class'] ?? '';
    $this->destinations = $s['destinations'] ?? vec[];
    $this->egress_endpoints = $s['egress_endpoints'] ?? vec[];
    $this->encoder_settings = $s['encoder_settings'] ?? null;
    $this->id = $s['id'] ?? '';
    $this->input_attachments = $s['input_attachments'] ?? vec[];
    $this->input_specification = $s['input_specification'] ?? null;
    $this->log_level = $s['log_level'] ?? '';
    $this->name = $s['name'] ?? '';
    $this->pipeline_details = $s['pipeline_details'] ?? vec[];
    $this->pipelines_running_count = $s['pipelines_running_count'] ?? 0;
...
class CreateInput {
  ...
  public function __construct(shape(
    ...
    $this->destinations = $s['destinations'] ?? vec[];
    $this->input_security_groups = $s['input_security_groups'] ?? vec[];
    $this->media_connect_flows = $s['media_connect_flows'] ?? vec[];
    $this->name = $s['name'] ?? '';
    $this->request_id = $s['request_id'] ?? '';
    $this->role_arn = $s['role_arn'] ?? '';
...
class CreateInputSecurityGroupRequest {
  ...
  public function __construct(shape(
    ...
    $this->tags = $s['tags'] ?? dict[];
    $this->whitelist_rules = $s['whitelist_rules'] ?? vec[];
  }
}
...
class CreateInputSecurityGroupResponse {
  ...
  public function __construct(shape(
    ...
    $this->security_group = $s['security_group'] ?? null;
  }
}
...
class CreateMultiplex {
  ...
  public function __construct(shape(
    ...
    $this->multiplex_settings = $s['multiplex_settings'] ?? null;
    $this->name = $s['name'] ?? '';
    $this->request_id = $s['request_id'] ?? '';
    $this->tags = $s['tags'] ?? dict[];
  }
...
class CreateMultiplexProgram {
  ...
  public function __construct(shape(
    ...
    $this->multiplex_program_settings = $s['multiplex_program_settings'] ?? null;
    $this->program_name = $s['program_name'] ?? '';
    $this->request_id = $s['request_id'] ?? '';
  }
}
...
class CreateMultiplexProgramRequest {
  ...
  public function __construct(shape(
    ...
    $this->multiplex_id = $s['multiplex_id'] ?? '';
    $this->multiplex_program_settings = $s['multiplex_program_settings'] ?? null;
    $this->program_name = $s['program_name'] ?? '';
    $this->request_id = $s['request_id'] ?? '';
  }
...
class CreateMultiplexProgramResponse {
  ...
  public function __construct(shape(
    ...
    $this->multiplex_program = $s['multiplex_program'] ?? null;
  }
}
...
class CreateMultiplexResponse {
  ...
  public function __construct(shape(
    ...
    $this->multiplex = $s['multiplex'] ?? null;
  }
}
...
class DeleteInputSecurityGroupRequest {
  ...
  public function __construct(shape(
    ...
    $this->input_security_group_id = $s['input_security_group_id'] ?? '';
  }
}
...
class DeleteMultiplexProgramResponse {
  ...
  public function __construct(shape(
    ...
    $this->channel_id = $s['channel_id'] ?? '';
    $this->multiplex_program_settings = $s['multiplex_program_settings'] ?? null;
    $this->packet_identifiers_map = $s['packet_identifiers_map'] ?? null;
    $this->program_name = $s['program_name'] ?? '';
  }
}
...
class DeleteMultiplexResponse {
  ...
  public function __construct(shape(
    ...
    $this->name = $s['name'] ?? '';
    $this->pipelines_running_count = $s['pipelines_running_count'] ?? 0;
    $this->program_count = $s['program_count'] ?? 0;
    $this->state = $s['state'] ?? '';
    $this->tags = $s['tags'] ?? dict[];
  }
}
...
class DeleteReservationResponse {
  ...
  public function __construct(shape(
    ...
    $this->duration_units = $s['duration_units'] ?? '';
    $this->end = $s['end'] ?? '';
    $this->fixed_price = $s['fixed_price'] ?? 0.0;
    $this->name = $s['name'] ?? '';
    $this->offering_description = $s['offering_description'] ?? '';
    $this->offering_id = $s['offering_id'] ?? '';
    $this->offering_type = $s['offering_type'] ?? '';
    $this->region = $s['region'] ?? '';
    $this->reservation_id = $s['reservation_id'] ?? '';
    $this->resource_specification = $s['resource_specification'] ?? null;
    $this->start = $s['start'] ?? '';
    $this->state = $s['state'] ?? '';
    $this->tags = $s['tags'] ?? dict[];
...
class DescribeInputResponse {
  ...
  public function __construct(shape(
    ...
    $this->arn = $s['arn'] ?? '';
    $this->attached_channels = $s['attached_channels'] ?? vec[];
    $this->destinations = $s['destinations'] ?? vec[];
    $this->id = $s['id'] ?? '';
    $this->input_class = $s['input_class'] ?? '';
    $this->input_source_type = $s['input_source_type'] ?? '';
    $this->media_connect_flows = $s['media_connect_flows'] ?? vec[];
    $this->name = $s['name'] ?? '';
    $this->role_arn = $s['role_arn'] ?? '';
...
class DvbNitSettings {
  ...
  public function __construct(shape(
    ...
    $this->rep_interval = $s['rep_interval'] ?? 0;
  }
}
...
class Eac3Settings {
  ...
  public function __construct(shape(
    ...
    $this->dialnorm = $s['dialnorm'] ?? 0;
    $this->drc_line = $s['drc_line'] ?? '';
    $this->drc_rf = $s['drc_rf'] ?? '';
...
class EmbeddedSourceSettings {
  ...
  public function __construct(shape(
    ...
    $this->scte_20_detection = $s['scte_20_detection'] ?? '';
...
class EncoderSettings {
  ...
  public function __construct(shape(
    ...
    $this->avail_configuration = $s['avail_configuration'] ?? null;
    $this->blackout_slate = $s['blackout_slate'] ?? null;
    $this->caption_descriptions = $s['caption_descriptions'] ?? vec[];
    $this->global_configuration = $s['global_configuration'] ?? null;
    ...
    $this->video_descriptions = $s['video_descriptions'] ?? vec[];
  }
}
...
class FecOutputSettings {
  ...
  public function __construct(shape(
    ...
    $this->column_depth = $s['column_depth'] ?? 0;
    $this->include_fec = $s['include_fec'] ?? '';
    $this->row_length = $s['row_length'] ?? 0;
  }
}
...
class FollowModeScheduleActionStartSettings {
  ...
  public function __construct(shape(
    ...
    $this->follow_point = $s['follow_point'] ?? '';
    $this->reference_action_name = $s['reference_action_name'] ?? '';
  }
}
...
class FrameCaptureSettings {
  ...
  public function __construct(shape(
    ...
    $this->capture_interval = $s['capture_interval'] ?? 0;
    $this->capture_interval_units = $s['capture_interval_units'] ?? '';
  }
}
...
class GlobalConfiguration {
  ...
  public function __construct(shape(
    ...
    $this->initial_audio_gain = $s['initial_audio_gain'] ?? 0;
    $this->input_end_action = $s['input_end_action'] ?? '';
    $this->input_loss_behavior = $s['input_loss_behavior'] ?? null;
    $this->output_locking_mode = $s['output_locking_mode'] ?? '';
    $this->output_timing_source = $s['output_timing_source'] ?? '';
    $this->support_low_framerate_inputs = $s['support_low_framerate_inputs'] ?? '';
  }
}
...
class H264ColorSpaceSettings {
  ...
  public function __construct(shape(
    ...
    $this->color_space_passthrough_settings = $s['color_space_passthrough_settings'] ?? null;
    $this->rec_601_settings = $s['rec_601_settings'] ?? null;
    $this->rec_709_settings = $s['rec_709_settings'] ?? null;
  }
}
...
class H264Settings {
  ...
  public function __construct(shape(
    ...
    $this->buf_fill_pct = $s['buf_fill_pct'] ?? 0;
    $this->buf_size = $s['buf_size'] ?? 0;
    $this->color_metadata = $s['color_metadata'] ?? '';
    $this->color_space_settings = $s['color_space_settings'] ?? null;
    $this->entropy_encoding = $s['entropy_encoding'] ?? '';
    $this->fixed_afd = $s['fixed_afd'] ?? '';
    $this->flicker_aq = $s['flicker_aq'] ?? '';
    $this->force_field_pictures = $s['force_field_pictures'] ?? '';
    ...
    $this->gop_num_b_frames = $s['gop_num_b_frames'] ?? 0;
    $this->gop_size = $s['gop_size'] ?? 0.0;
    $this->gop_size_units = $s['gop_size_units'] ?? '';
    $this->level = $s['level'] ?? '';
    $this->look_ahead_rate_control = $s['look_ahead_rate_control'] ?? '';
    $this->max_bitrate = $s['max_bitrate'] ?? 0;
    $this->min_i_interval = $s['min_i_interval'] ?? 0;
    $this->num_ref_frames = $s['num_ref_frames'] ?? 0;
    ...
    $this->rate_control_mode = $s['rate_control_mode'] ?? '';
    $this->scan_type = $s['scan_type'] ?? '';
    $this->scene_change_detect = $s['scene_change_detect'] ?? '';
    $this->slices = $s['slices'] ?? 0;
    $this->softness = $s['softness'] ?? 0;
    $this->spatial_aq = $s['spatial_aq'] ?? '';
    $this->subgop_length = $s['subgop_length'] ?? '';
    $this->syntax = $s['syntax'] ?? '';
    $this->temporal_aq = $s['temporal_aq'] ?? '';
...
class H265ColorSpaceSettings {
  ...
  public function __construct(shape(
    ...
    $this->color_space_passthrough_settings = $s['color_space_passthrough_settings'] ?? null;
    $this->hdr_10_settings = $s['hdr_10_settings'] ?? null;
    $this->rec_601_settings = $s['rec_601_settings'] ?? null;
    $this->rec_709_settings = $s['rec_709_settings'] ?? null;
  }
}
...
class H265Settings {
  ...
  public function __construct(shape(
    ...
    $this->adaptive_quantization = $s['adaptive_quantization'] ?? '';
    $this->afd_signaling = $s['afd_signaling'] ?? '';
    $this->alternative_transfer_function = $s['alternative_transfer_function'] ?? '';
    $this->bitrate = $s['bitrate'] ?? 0;
    $this->buf_size = $s['buf_size'] ?? 0;
    $this->color_metadata = $s['color_metadata'] ?? '';
    $this->color_space_settings = $s['color_space_settings'] ?? null;
...
class HlsAkamaiSettings {
  ...
  public function __construct(shape(
    ...
    $this->connection_retry_interval = $s['connection_retry_interval'] ?? 0;
    $this->filecache_duration = $s['filecache_duration'] ?? 0;
    $this->http_transfer_mode = $s['http_transfer_mode'] ?? '';
    $this->num_retries = $s['num_retries'] ?? 0;
    $this->restart_delay = $s['restart_delay'] ?? 0;
    $this->salt = $s['salt'] ?? '';
    $this->token = $s['token'] ?? '';
  }
}
...
class HlsCdnSettings {
  ...
  public function __construct(shape(
    ...
    $this->hls_akamai_settings = $s['hls_akamai_settings'] ?? null;
    $this->hls_basic_put_settings = $s['hls_basic_put_settings'] ?? null;
    $this->hls_media_store_settings = $s['hls_media_store_settings'] ?? null;
    $this->hls_webdav_settings = $s['hls_webdav_settings'] ?? null;
  }
}
...
class HlsGroupSettings {
  ...
  public function __construct(shape(
    ...
    $this->base_url_content = $s['base_url_content'] ?? '';
    $this->base_url_content_1 = $s['base_url_content_1'] ?? '';
    $this->base_url_manifest = $s['base_url_manifest'] ?? '';
    $this->base_url_manifest_1 = $s['base_url_manifest_1'] ?? '';
    ...
    $this->constant_iv = $s['constant_iv'] ?? '';
    $this->destination = $s['destination'] ?? null;
    $this->directory_structure = $s['directory_structure'] ?? '';
    $this->encryption_type = $s['encryption_type'] ?? '';
    $this->hls_cdn_settings = $s['hls_cdn_settings'] ?? null;
    $this->hls_id_3_segment_tagging = $s['hls_id_3_segment_tagging'] ?? '';
    $this->i_frame_only_playlists = $s['i_frame_only_playlists'] ?? '';
    $this->index_n_segments = $s['index_n_segments'] ?? 0;
    $this->input_loss_action = $s['input_loss_action'] ?? '';
    $this->iv_in_manifest = $s['iv_in_manifest'] ?? '';
    $this->iv_source = $s['iv_source'] ?? '';
    $this->keep_segments = $s['keep_segments'] ?? 0;
    $this->key_format = $s['key_format'] ?? '';
    $this->key_format_versions = $s['key_format_versions'] ?? '';
    $this->key_provider_settings = $s['key_provider_settings'] ?? null;
    ...
    $this->redundant_manifest = $s['redundant_manifest'] ?? '';
    $this->segment_length = $s['segment_length'] ?? 0;
    $this->segmentation_mode = $s['segmentation_mode'] ?? '';
    ...
    $this->ts_file_mode = $s['ts_file_mode'] ?? '';
  }
}
...
class HlsInputSettings {
  ...
  public function __construct(shape(
    ...
    $this->bandwidth = $s['bandwidth'] ?? 0;
    $this->buffer_segments = $s['buffer_segments'] ?? 0;
    $this->retries = $s['retries'] ?? 0;
    $this->retry_interval = $s['retry_interval'] ?? 0;
  }
}
...
class HlsMediaStoreSettings {
  ...
  public function __construct(shape(
    ...
    $this->connection_retry_interval = $s['connection_retry_interval'] ?? 0;
    $this->filecache_duration = $s['filecache_duration'] ?? 0;
    $this->media_store_storage_class = $s['media_store_storage_class'] ?? '';
    $this->num_retries = $s['num_retries'] ?? 0;
    $this->restart_delay = $s['restart_delay'] ?? 0;
  }
}
...
class HlsOutputSettings {
  ...
  public function __construct(shape(
    ...
    $this->h_265_packaging_type = $s['h_265_packaging_type'] ?? '';
...
class HlsSettings {
  ...
  public function __construct(shape(
    ...
    $this->audio_only_hls_settings = $s['audio_only_hls_settings'] ?? null;
    $this->fmp_4_hls_settings = $s['fmp_4_hls_settings'] ?? null;
    $this->standard_hls_settings = $s['standard_hls_settings'] ?? null;
  }
}
...
class InputAttachment {
  ...
  public function __construct(shape(
    ...
    $this->automatic_input_failover_settings = $s['automatic_input_failover_settings'] ?? null;
    $this->input_attachment_name = $s['input_attachment_name'] ?? '';
    $this->input_id = $s['input_id'] ?? '';
    $this->input_settings = $s['input_settings'] ?? null;
  }
}
...
class InputChannelLevel {
  ...
  public function __construct(shape(
    ...
    $this->gain = $s['gain'] ?? 0;
    $this->input_channel = $s['input_channel'] ?? 0;
  }
}
...
class InputClippingSettings {
  ...
  public function __construct(shape(
    ...
    $this->input_timecode_source = $s['input_timecode_source'] ?? '';
    $this->start_timecode = $s['start_timecode'] ?? null;
    $this->stop_timecode = $s['stop_timecode'] ?? null;
  }
}
...
class InputLocation {
  ...
  public function __construct(shape(
    ...
    $this->password_param = $s['password_param'] ?? '';
    $this->uri = $s['uri'] ?? '';
...
class InputLossBehavior {
  ...
  public function __construct(shape(
    ...
    $this->black_frame_msec = $s['black_frame_msec'] ?? 0;
    $this->input_loss_image_color = $s['input_loss_image_color'] ?? '';
    $this->input_loss_image_slate = $s['input_loss_image_slate'] ?? null;
    $this->input_loss_image_type = $s['input_loss_image_type'] ?? '';
    $this->repeat_frame_msec = $s['repeat_frame_msec'] ?? 0;
  }
}
...
class InputSettings {
  ...
  public function __construct(shape(
    ...
    $this->audio_selectors = $s['audio_selectors'] ?? vec[];
    $this->caption_selectors = $s['caption_selectors'] ?? vec[];
    ...
    $this->network_input_settings = $s['network_input_settings'] ?? null;
    $this->source_end_behavior = $s['source_end_behavior'] ?? '';
...
class InputSpecification {
  ...
  public function __construct(shape(
    ...
    $this->codec = $s['codec'] ?? '';
    $this->maximum_bitrate = $s['maximum_bitrate'] ?? '';
...
class InputSwitchScheduleActionSettings {
  ...
  public function __construct(shape(
    ...
    $this->input_attachment_name_reference = $s['input_attachment_name_reference'] ?? '';
    $this->input_clipping_settings = $s['input_clipping_settings'] ?? null;
    $this->url_path = $s['url_path'] ?? vec[];
  }
}
...
class KeyProviderSettings {
  ...
  public function __construct(shape(
    ...
    $this->static_key_settings = $s['static_key_settings'] ?? null;
  }
}
...
class ListMultiplexProgramsResponse {
  ...
  public function __construct(shape(
    ...
    $this->multiplex_programs = $s['multiplex_programs'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListMultiplexesResponse {
  ...
  public function __construct(shape(
    ...
    $this->multiplexes = $s['multiplexes'] ?? vec[];
    $this->next_token = $s['next_token'] ?? '';
  }
}
...
class ListOfferingsRequest {
  ...
  public function __construct(shape(
    ...
    $this->channel_class = $s['channel_class'] ?? '';
    $this->channel_configuration = $s['channel_configuration'] ?? '';
    $this->codec = $s['codec'] ?? '';
    $this->duration = $s['duration'] ?? '';
    $this->max_results = $s['max_results'] ?? 0;
    $this->maximum_bitrate = $s['maximum_bitrate'] ?? '';
    $this->maximum_framerate = $s['maximum_framerate'] ?? '';
    $this->next_token = $s['next_token'] ?? '';
    $this->resolution = $s['resolution'] ?? '';
    $this->resource_type = $s['resource_type'] ?? '';
    $this->special_feature = $s['special_feature'] ?? '';
    $this->video_quality = $s['video_quality'] ?? '';
  }
}
...
class M2tsSettings {
  ...
  public function __construct(shape(
    ...
    $this->absent_input_audio_behavior = $s['absent_input_audio_behavior'] ?? '';
    $this->arib = $s['arib'] ?? '';
    $this->arib_captions_pid = $s['arib_captions_pid'] ?? '';
    $this->arib_captions_pid_control = $s['arib_captions_pid_control'] ?? '';
    $this->audio_buffer_model = $s['audio_buffer_model'] ?? '';
    $this->audio_frames_per_pes = $s['audio_frames_per_pes'] ?? 0;
    $this->audio_pids = $s['audio_pids'] ?? '';
    $this->audio_stream_type = $s['audio_stream_type'] ?? '';
    $this->bitrate = $s['bitrate'] ?? 0;
    $this->buffer_model = $s['buffer_model'] ?? '';
    $this->cc_descriptor = $s['cc_descriptor'] ?? '';
    $this->dvb_nit_settings = $s['dvb_nit_settings'] ?? null;
    $this->dvb_sdt_settings = $s['dvb_sdt_settings'] ?? null;
    $this->dvb_sub_pids = $s['dvb_sub_pids'] ?? '';
    $this->dvb_tdt_settings = $s['dvb_tdt_settings'] ?? null;
    $this->dvb_teletext_pid = $s['dvb_teletext_pid'] ?? '';
    $this->ebif = $s['ebif'] ?? '';
    $this->ebp_audio_interval = $s['ebp_audio_interval'] ?? '';
    $this->ebp_lookahead_ms = $s['ebp_lookahead_ms'] ?? 0;
    $this->ebp_placement = $s['ebp_placement'] ?? '';
    $this->ecm_pid = $s['ecm_pid'] ?? '';
    $this->es_rate_in_pes = $s['es_rate_in_pes'] ?? '';
    $this->etv_platform_pid = $s['etv_platform_pid'] ?? '';
    $this->etv_signal_pid = $s['etv_signal_pid'] ?? '';
    $this->fragment_time = $s['fragment_time'] ?? 0.0;
    $this->klv = $s['klv'] ?? '';
    $this->klv_data_pids = $s['klv_data_pids'] ?? '';
    $this->nielsen_id_3_behavior = $s['nielsen_id_3_behavior'] ?? '';
    $this->null_packet_bitrate = $s['null_packet_bitrate'] ?? 0.0;
    $this->pat_interval = $s['pat_interval'] ?? 0;
    $this->pcr_control = $s['pcr_control'] ?? '';
    $this->pcr_period = $s['pcr_period'] ?? 0;
    $this->pcr_pid = $s['pcr_pid'] ?? '';
    $this->pmt_interval = $s['pmt_interval'] ?? 0;
    $this->pmt_pid = $s['pmt_pid'] ?? '';
    $this->program_num = $s['program_num'] ?? 0;
    $this->rate_mode = $s['rate_mode'] ?? '';
    $this->scte_27_pids = $s['scte_27_pids'] ?? '';
    $this->scte_35_control = $s['scte_35_control'] ?? '';
    $this->scte_35_pid = $s['scte_35_pid'] ?? '';
    ...
    $this->timed_metadata_behavior = $s['timed_metadata_behavior'] ?? '';
    $this->timed_metadata_pid = $s['timed_metadata_pid'] ?? '';
    $this->transport_stream_id = $s['transport_stream_id'] ?? 0;
    $this->video_pid = $s['video_pid'] ?? '';
  }
}
...
class M3u8Settings {
  ...
  public function __construct(shape(
    ...
    $this->pmt_pid = $s['pmt_pid'] ?? '';
    $this->program_num = $s['program_num'] ?? 0;
    $this->scte_35_behavior = $s['scte_35_behavior'] ?? '';
    $this->scte_35_pid = $s['scte_35_pid'] ?? '';
    $this->timed_metadata_behavior = $s['timed_metadata_behavior'] ?? '';
    $this->timed_metadata_pid = $s['timed_metadata_pid'] ?? '';
    $this->transport_stream_id = $s['transport_stream_id'] ?? 0;
...
class MsSmoothGroupSettings {
  ...
  public function __construct(shape(
    ...
    $this->acquisition_point_id = $s['acquisition_point_id'] ?? '';
    $this->audio_only_timecode_control = $s['audio_only_timecode_control'] ?? '';
    $this->certificate_mode = $s['certificate_mode'] ?? '';
    $this->connection_retry_interval = $s['connection_retry_interval'] ?? 0;
    $this->destination = $s['destination'] ?? null;
    $this->event_id = $s['event_id'] ?? '';
    $this->event_id_mode = $s['event_id_mode'] ?? '';
    $this->event_stop_behavior = $s['event_stop_behavior'] ?? '';
    $this->filecache_duration = $s['filecache_duration'] ?? 0;
    ...
    $this->restart_delay = $s['restart_delay'] ?? 0;
    $this->segmentation_mode = $s['segmentation_mode'] ?? '';
    $this->send_delay_ms = $s['send_delay_ms'] ?? 0;
    $this->sparse_track_type = $s['sparse_track_type'] ?? '';
    $this->stream_manifest_behavior = $s['stream_manifest_behavior'] ?? '';
    $this->timestamp_offset = $s['timestamp_offset'] ?? '';
    $this->timestamp_offset_mode = $s['timestamp_offset_mode'] ?? '';
  }
}
...
class MultiplexOutputDestination {
  ...
  public function __construct(shape(
    ...
    $this->media_connect_settings = $s['media_connect_settings'] ?? null;
  }
}
...
class MultiplexProgramPacketIdentifiersMap {
  ...
  public function __construct(shape(
    ...
    $this->etv_platform_pid = $s['etv_platform_pid'] ?? 0;
    $this->etv_signal_pid = $s['etv_signal_pid'] ?? 0;
    $this->klv_data_pids = $s['klv_data_pids'] ?? vec[];
    $this->pcr_pid = $s['pcr_pid'] ?? 0;
    $this->pmt_pid = $s['pmt_pid'] ?? 0;
    $this->private_metadata_pid = $s['private_metadata_pid'] ?? 0;
    $this->scte_27_pids = $s['scte_27_pids'] ?? vec[];
...
class MultiplexProgramSettings {
  ...
  public function __construct(shape(
    ...
    $this->preferred_channel_pipeline = $s['preferred_channel_pipeline'] ?? '';
    $this->program_number = $s['program_number'] ?? 0;
    $this->service_descriptor = $s['service_descriptor'] ?? null;
    $this->video_settings = $s['video_settings'] ?? null;
  }
}
...
class MultiplexSettings {
  ...
  public function __construct(shape(
    ...
    $this->maximum_video_buffer_delay_milliseconds = $s['maximum_video_buffer_delay_milliseconds'] ?? 0;
    $this->transport_stream_bitrate = $s['transport_stream_bitrate'] ?? 0;
    $this->transport_stream_id = $s['transport_stream_id'] ?? 0;
    $this->transport_stream_reserved_bitrate = $s['transport_stream_reserved_bitrate'] ?? 0;
  }
}
...
class MultiplexStatmuxVideoSettings {
  ...
  public function __construct(shape(
    ...
    $this->maximum_bitrate = $s['maximum_bitrate'] ?? 0;
    $this->minimum_bitrate = $s['minimum_bitrate'] ?? 0;
  }
}
...
class MultiplexValidationError {
  ...
  public function __construct(shape(
    ...
    $this->element_path = $s['element_path'] ?? '';
...
class MultiplexVideoSettings {
  ...
  public function __construct(shape(
    ...
    $this->constant_bitrate = $s['constant_bitrate'] ?? 0;
    $this->statmux_settings = $s['statmux_settings'] ?? null;
  }
}
...
class NetworkInputSettings {
  ...
  public function __construct(shape(
    ...
    $this->hls_input_settings = $s['hls_input_settings'] ?? null;
    $this->server_validation = $s['server_validation'] ?? '';
  }
}
...
class NielsenConfiguration {
  ...
  public function __construct(shape(
    ...
    $this->nielsen_pcm_to_id_3_tagging = $s['nielsen_pcm_to_id_3_tagging'] ?? '';
  }
}
...
class Output {
  ...
  public function __construct(shape(
    ...
    $this->audio_description_names = $s['audio_description_names'] ?? vec[];
    $this->caption_description_names = $s['caption_description_names'] ?? vec[];
    $this->output_name = $s['output_name'] ?? '';
    $this->output_settings = $s['output_settings'] ?? null;
    $this->video_description_name = $s['video_description_name'] ?? '';
  }
}
...
class OutputDestination {
  ...
  public function __construct(shape(
    ...
    $this->id = $s['id'] ?? '';
    $this->media_package_settings = $s['media_package_settings'] ?? vec[];
    $this->multiplex_settings = $s['multiplex_settings'] ?? null;
...
class OutputGroupSettings {
  ...
  public function __construct(shape(
    ...
    $this->archive_group_settings = $s['archive_group_settings'] ?? null;
    $this->frame_capture_group_settings = $s['frame_capture_group_settings'] ?? null;
    $this->hls_group_settings = $s['hls_group_settings'] ?? null;
    $this->media_package_group_settings = $s['media_package_group_settings'] ?? null;
    $this->ms_smooth_group_settings = $s['ms_smooth_group_settings'] ?? null;
    $this->multiplex_group_settings = $s['multiplex_group_settings'] ?? null;
    $this->rtmp_group_settings = $s['rtmp_group_settings'] ?? null;
    $this->udp_group_settings = $s['udp_group_settings'] ?? null;
  }
}
...
class OutputLocationRef {
  ...
  public function __construct(shape(
    ...
    $this->destination_ref_id = $s['destination_ref_id'] ?? '';
  }
}
...
class OutputSettings {
  ...
  public function __construct(shape(
    ...
    $this->archive_output_settings = $s['archive_output_settings'] ?? null;
    $this->frame_capture_output_settings = $s['frame_capture_output_settings'] ?? null;
    $this->hls_output_settings = $s['hls_output_settings'] ?? null;
    $this->media_package_output_settings = $s['media_package_output_settings'] ?? null;
    $this->ms_smooth_output_settings = $s['ms_smooth_output_settings'] ?? null;
    $this->multiplex_output_settings = $s['multiplex_output_settings'] ?? null;
    $this->rtmp_output_settings = $s['rtmp_output_settings'] ?? null;
    $this->udp_output_settings = $s['udp_output_settings'] ?? null;
  }
}
...
class PipelineDetail {
  ...
  public function __construct(shape(
    ...
    $this->active_input_attachment_name = $s['active_input_attachment_name'] ?? '';
    $this->active_input_switch_action_name = $s['active_input_switch_action_name'] ?? '';
...
class PurchaseOfferingResponse {
  ...
  public function __construct(shape(
    ...
    $this->reservation = $s['reservation'] ?? null;
  }
}
...
class RemixSettings {
  ...
  public function __construct(shape(
    ...
    $this->channel_mappings = $s['channel_mappings'] ?? vec[];
...
class RtmpGroupSettings {
  ...
  public function __construct(shape(
    ...
    $this->authentication_scheme = $s['authentication_scheme'] ?? '';
    $this->cache_full_behavior = $s['cache_full_behavior'] ?? '';
    $this->cache_length = $s['cache_length'] ?? 0;
    $this->caption_data = $s['caption_data'] ?? '';
    $this->input_loss_action = $s['input_loss_action'] ?? '';
    $this->restart_delay = $s['restart_delay'] ?? 0;
  }
}
...
class ScheduleAction {
  ...
  public function __construct(shape(
    ...
    $this->schedule_action_settings = $s['schedule_action_settings'] ?? null;
    $this->schedule_action_start_settings = $s['schedule_action_start_settings'] ?? null;
  }
}
...
class ScheduleActionSettings {
  ...
  public function __construct(shape(
    ...
    $this->hls_id_3_segment_tagging_settings = $s['hls_id_3_segment_tagging_settings'] ?? null;
    $this->hls_timed_metadata_settings = $s['hls_timed_metadata_settings'] ?? null;
    $this->input_switch_settings = $s['input_switch_settings'] ?? null;
    $this->pause_state_settings = $s['pause_state_settings'] ?? null;
    $this->scte_35_return_to_network_settings = $s['scte_35_return_to_network_settings'] ?? null;
    $this->scte_35_splice_insert_settings = $s['scte_35_splice_insert_settings'] ?? null;
    $this->scte_35_time_signal_settings = $s['scte_35_time_signal_settings'] ?? null;
    $this->static_image_activate_settings = $s['static_image_activate_settings'] ?? null;
    $this->static_image_deactivate_settings = $s['static_image_deactivate_settings'] ?? null;
  }
}
...
class ScheduleActionStartSettings {
  ...
  public function __construct(shape(
    ...
    $this->fixed_mode_schedule_action_start_settings = $s['fixed_mode_schedule_action_start_settings'] ?? null;
    $this->follow_mode_schedule_action_start_settings = $s['follow_mode_schedule_action_start_settings'] ?? null;
    $this->immediate_mode_schedule_action_start_settings = $s['immediate_mode_schedule_action_start_settings'] ?? null;
  }
}
...
class Scte35DeliveryRestrictions {
  ...
  public function __construct(shape(
    ...
    $this->archive_allowed_flag = $s['archive_allowed_flag'] ?? '';
    $this->device_restrictions = $s['device_restrictions'] ?? '';
    $this->no_regional_blackout_flag = $s['no_regional_blackout_flag'] ?? '';
    $this->web_delivery_allowed_flag = $s['web_delivery_allowed_flag'] ?? '';
  }
}
...
class Scte35Descriptor {
  ...
  public function __construct(shape(
    ...
    $this->scte_35_descriptor_settings = $s['scte_35_descriptor_settings'] ?? null;
  }
}
...
class Scte35DescriptorSettings {
  ...
  public function __construct(shape(
    ...
    $this->segmentation_descriptor_scte_35_descriptor_settings = $s['segmentation_descriptor_scte_35_descriptor_settings'] ?? null;
  }
}
...
class Scte35ReturnToNetworkScheduleActionSettings {
  ...
  public function __construct(shape(
    ...
    $this->splice_event_id = $s['splice_event_id'] ?? 0;
  }
}
...
class Scte35SegmentationDescriptor {
  ...
  public function __construct(shape(
    ...
    $this->delivery_restrictions = $s['delivery_restrictions'] ?? null;
    $this->segment_num = $s['segment_num'] ?? 0;
    $this->segmentation_cancel_indicator = $s['segmentation_cancel_indicator'] ?? '';
    $this->segmentation_duration = $s['segmentation_duration'] ?? 0;
    $this->segmentation_event_id = $s['segmentation_event_id'] ?? 0;
    $this->segmentation_type_id = $s['segmentation_type_id'] ?? 0;
    $this->segmentation_upid = $s['segmentation_upid'] ?? '';
    $this->segmentation_upid_type = $s['segmentation_upid_type'] ?? 0;
    $this->segments_expected = $s['segments_expected'] ?? 0;
    $this->sub_segment_num = $s['sub_segment_num'] ?? 0;
    $this->sub_segments_expected = $s['sub_segments_expected'] ?? 0;
  }
}
...
class Scte35TimeSignalScheduleActionSettings {
  ...
  public function __construct(shape(
    ...
    $this->scte_35_descriptors = $s['scte_35_descriptors'] ?? vec[];
  }
}
...
class StaticKeySettings {
  ...
  public function __construct(shape(
    ...
    $this->key_provider_server = $s['key_provider_server'] ?? null;
...
class StopTimecode {
  ...
  public function __construct(shape(
    ...
    $this->last_frame_clipping_behavior = $s['last_frame_clipping_behavior'] ?? '';
    $this->timecode = $s['timecode'] ?? '';
  }
}
...
class TimecodeConfig {
  ...
  public function __construct(shape(
    ...
    $this->sync_threshold = $s['sync_threshold'] ?? 0;
  }
}
...
class TtmlDestinationSettings {
  ...
  public function __construct(shape(
    ...
    $this->style_control = $s['style_control'] ?? '';
  }
}
...
class UdpOutputSettings {
  ...
  public function __construct(shape(
    ...
    $this->buffer_msec = $s['buffer_msec'] ?? 0;
    $this->container_settings = $s['container_settings'] ?? null;
    $this->destination = $s['destination'] ?? null;
    $this->fec_output_settings = $s['fec_output_settings'] ?? null;
  }
}
...
class VideoSelectorProgramId {
  ...
  public function __construct(shape(
    ...
    $this->program_id = $s['program_id'] ?? 0;
  }
}
...
class VideoSelectorSettings {
  ...
  public function __construct(shape(
    ...
    $this->video_selector_pid = $s['video_selector_pid'] ?? null;
    $this->video_selector_program_id = $s['video_selector_program_id'] ?? null;
  }
}
